...
function InAppWalletFormUIScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { fullHeight: true, flex: "column", p: "lg", animate: "fadein", style: {
            minHeight: "250px",
        }, children: [isCompact ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { onBack: onBack, title: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [!connectModal.titleIcon ? null : ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: connectModal.titleIcon, width: index_js_1.iconSize.md, height: index_js_1.iconSize.md, client: client })), (0, jsx_runtime_1.jsx)(modalElements_js_1.ModalTitle, { children: connectModal.title ?? locale.title })] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] })) : null, (0, jsx_runtime_1.jsx)(basic_js_1.Container, { expand: true, flex: "column", center: "y", p: isCompact ? undefined : "lg", children: (0, jsx_runtime_1.jsx)(exports.InAppWalletFormUI, { ...props }) }), isCompact &&
