...
exports.useWalletDetailsModal = exports.ConnectedWalletDetails = void 0;
                        ...
                        gap: index_js_2.spacing.xs,
                            ...
                            gap: "1px",
                                ...
                                !activeWallet.getConfig()?.hidePrivateKeyExport && ((0, jsx_runtime_1.jsxs)(MenuButton, { onClick: () => {
                                    ...
                                    fontSize: index_js_2.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(KeyIcon_js_1.KeyIcon, { size: index_js_2.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: "Export Private Key" })] })), (0, jsx_runtime_1.jsx)(SwitchMetamaskAccount, { closeModal: closeModal, connectLocale: locale }), (props.detailsModal?.showTestnetFaucet ?? false) &&
    ...
    function openModal(props) {
        ...
        (0, getConnectLocale_js_1.getConnectLocale)(props.locale || "en_US")
            ...
            setRootEl((0, jsx_runtime_1.jsx)(DetailsModal, { client: props.client, locale: locale, detailsModal: {
                ...
                }, displayBalanceToken: props.displayBalanceToken, theme: props.theme || "dark", supportedTokens: props.supportedTokens, closeModal: closeModal, onDisconnect: closeModal, chains: props.chains || [] }));
        })
            .catch(() => {
            closeModal();
        });
