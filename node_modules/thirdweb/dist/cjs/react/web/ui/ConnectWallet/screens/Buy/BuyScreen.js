...
function BuyScreenContent(props) {
    ...
    // UI selection
    const { tokenAmount, setTokenAmount, setHasEditedAmount, hasEditedAmount, toChain, setToChain, deferredTokenAmount, fromChain, setFromChain, toToken, setToToken, fromToken, setFromToken, selectedCurrency, setSelectedCurrency, } = (0, useUISelectionStates_js_1.useUISelectionStates)({
        payOptions,
        buyForTx,
