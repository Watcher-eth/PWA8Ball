...
function useSendTransaction(config = {}) {
    ...
    return (0, useSendTransaction_js_1.useSendTransactionCore)(!payModalEnabled || payModal === false
        ? undefined
        : (data) => {
...
function ExecutingTxScreen(props) {
    const sendTxCore = (0, useSendTransaction_js_1.useSendTransactionCore)();
