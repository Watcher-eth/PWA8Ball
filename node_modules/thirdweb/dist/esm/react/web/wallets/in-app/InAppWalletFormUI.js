...
export function InAppWalletFormUIScreen(props) {
    ...
    return (_jsxs(Container, { fullHeight: true, flex: "column", p: "lg", animate: "fadein", style: {
            minHeight: "250px",
        }, children: [isCompact ? (_jsxs(_Fragment, { children: [_jsx(ModalHeader, { onBack: onBack, title: _jsxs(_Fragment, { children: [!connectModal.titleIcon ? null : (_jsx(Img, { src: connectModal.titleIcon, width: iconSize.md, height: iconSize.md, client: client })), _jsx(ModalTitle, { children: connectModal.title ?? locale.title })] }) }), _jsx(Spacer, { y: "lg" })] })) : null, _jsx(Container, { expand: true, flex: "column", center: "y", p: isCompact ? undefined : "lg", children: _jsx(InAppWalletFormUI, { ...props }) }), isCompact &&
