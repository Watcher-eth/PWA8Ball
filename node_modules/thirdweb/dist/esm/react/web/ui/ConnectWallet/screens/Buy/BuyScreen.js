...
function BuyScreenContent(props) {
    ...
    // UI selection
    const { tokenAmount, setTokenAmount, setHasEditedAmount, hasEditedAmount, toChain, setToChain, deferredTokenAmount, fromChain, setFromChain, toToken, setToToken, fromToken, setFromToken, selectedCurrency, setSelectedCurrency, } = useUISelectionStates({
        payOptions,
        buyForTx,
                ...
                if (drawerScreen &&
                    ...
                    closeDrawer();
                        ...
                        paddingBottom: 0,
                            ...
                            }, account: account })), _jsx(Spacer, { y: "sm" })] })), _jsxs(Container, { px: "lg", flex: "column", gap: "sm", children: [!isExpanded && (_jsx(_Fragment, { children: !account && props.connectButton ? (_jsx("div", { children: props.connectButton })) : (_jsx(Button, { variant: "accent", fullWidth: true, disabled: true, "data-disable": true, children: "Continue" })) })), account && (_jsx(Button, { variant: "outline", fullWidth: true, style: {
                                padding: spacing.xs,
                                fontSize: fontSize.sm,
                            }, onClick: props.onViewPendingTx, children: "View all transactions" }))] }), _jsx(Spacer, { y: "lg" })] }) }));
}
