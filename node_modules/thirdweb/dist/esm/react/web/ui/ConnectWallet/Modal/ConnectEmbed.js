...
export function ConnectEmbed(props) {
    ...
    if (show) {
        if (!localeQuery.data) {
            return (_jsxs(_Fragment, { children: [autoConnectComp, _jsx(CustomThemeProvider, { theme: props.theme || "dark", children: _jsx(EmbedContainer, { modalSize: modalSize, children: _jsx(LoadingScreen, {}) }) })] }));
        }
