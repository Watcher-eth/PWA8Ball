    ...
    return (_jsxs(Container, { animate: "fadein", children: [_jsx(Container, { p: "lg", children: _jsx(ModalHeader, { title: "Transactions", onBack: props.onBack }) }), _jsxs(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
                    ...
                    maxHeight: "370px",
                                ...
                                gap: spacing.sm,
                                        ...
                                        setPageIndex((prev) => prev + 1);
                                    }, children: ["Next", _jsx(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm })] })] })) })] }), _jsx(Line, {}), _jsx(Container, { p: "lg", children: _jsxs(ButtonLink, { fullWidth: true, variant: "outline", href: `${chainQuery.data?.explorers?.[0]?.url}/address/${activeAccount?.address}`, target: "_blank", as: "a", gap: "xs", style: {
                        textDecoration: "none",
                        color: "inherit",
