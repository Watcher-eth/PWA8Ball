                        ...
                        gap: spacing.xs,
                            ...
                            gap: "1px",
                                ...
                                !activeWallet.getConfig()?.hidePrivateKeyExport && (_jsxs(MenuButton, { onClick: () => {
                                    ...
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(KeyIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: "Export Private Key" })] })), _jsx(SwitchMetamaskAccount, { closeModal: closeModal, connectLocale: locale }), (props.detailsModal?.showTestnetFaucet ?? false) &&
