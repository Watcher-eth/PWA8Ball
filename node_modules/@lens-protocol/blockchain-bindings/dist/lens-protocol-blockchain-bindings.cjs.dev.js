...
function lensFollowNFT(address, provider) {
  return new ethers.Contract(address, lensFollowNftAbi, provider);
}
function lensHub(address, provider) {
  return new ethers.Contract(address, lensHubAbi, provider);
}
function lensTokenHandleRegistry(address, provider) {
  return new ethers.Contract(address, lensTokenHandleRegistryAbi, provider);
}
function publicActProxy(address, provider) {
  return new ethers.Contract(address, publicActProxyAbi, provider);
}
...
function bigNumber(from) {
  return ethers.utils.parseUnits(from.toFixed(), from.asset.decimals);
}
