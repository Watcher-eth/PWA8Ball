...
export type ApprovedModuleAllowanceAmountData = {
    result: Array<ApprovedAllowanceAmountResult>;
};
...
export declare const FragmentImageTransformParam: Apollo.DocumentNode;
export declare const FragmentInjectCommonQueryParams: Apollo.DocumentNode;
...
export declare const FragmentKnownSupportedModule: Apollo.DocumentNode;
export declare const FragmentUnknownSupportedModule: Apollo.DocumentNode;
export declare const FragmentApprovedAllowanceAmountResult: Apollo.DocumentNode;
export declare const FragmentGenerateModuleCurrencyApprovalResult: Apollo.DocumentNode;
...
export type ActOnOpenActionMutationFn = Apollo.MutationFunction<ActOnOpenActionData, ActOnOpenActionVariables>;
/**
...
export type CreateActOnOpenActionTypedDataMutationFn = Apollo.MutationFunction<CreateActOnOpenActionTypedDataData, CreateActOnOpenActionTypedDataVariables>;
/**
...
export type WalletAuthenticationToProfileAuthenticationMutationFn = Apollo.MutationFunction<WalletAuthenticationToProfileAuthenticationData, WalletAuthenticationToProfileAuthenticationVariables>;
/**
...
export type RevokeAuthenticationMutationFn = Apollo.MutationFunction<RevokeAuthenticationData, RevokeAuthenticationVariables>;
/**
...
export declare function useExplorePublications(baseOptions: Apollo.QueryHookOptions<ExplorePublicationsData, ExplorePublicationsVariables>): Apollo.QueryResult<ExplorePublicationsData, Exact<{
    ...
    imageSmallSize?: InputMaybe<ImageTransform> | undefined;
    imageMediumSize?: InputMaybe<ImageTransform> | undefined;
    profileCoverSize?: InputMaybe<ImageTransform> | undefined;
    profilePictureSize?: InputMaybe<ImageTransform> | undefined;
    activityOn?: InputMaybe<AppId | AppId[]> | undefined;
    fxRateFor?: InputMaybe<SupportedFiatType> | undefined;
}>>;
...
export declare const ApprovedModuleAllowanceAmountDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useApprovedModuleAllowanceAmount(baseOptions: Apollo.QueryHookOptions<ApprovedModuleAllowanceAmountData, ApprovedModuleAllowanceAmountVariables>): Apollo.QueryResult<ApprovedModuleAllowanceAmountData, Exact<{
    request: ApprovedModuleAllowanceAmountRequest;
    fxRateFor?: InputMaybe<SupportedFiatType> | undefined;
}>>;
export declare function useApprovedModuleAllowanceAmountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ApprovedModuleAllowanceAmountData, ApprovedModuleAllowanceAmountVariables>): Apollo.LazyQueryResultTuple<ApprovedModuleAllowanceAmountData, Exact<{
    request: ApprovedModuleAllowanceAmountRequest;
    fxRateFor?: InputMaybe<SupportedFiatType> | undefined;
}>>;
export type ApprovedModuleAllowanceAmountHookResult = ReturnType<typeof useApprovedModuleAllowanceAmount>;
export type ApprovedModuleAllowanceAmountLazyQueryHookResult = ReturnType<typeof useApprovedModuleAllowanceAmountLazyQuery>;
export type ApprovedModuleAllowanceAmountQueryResult = Apollo.QueryResult<ApprovedModuleAllowanceAmountData, ApprovedModuleAllowanceAmountVariables>;
export declare const GenerateModuleCurrencyApprovalDataDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useGenerateModuleCurrencyApprovalData(baseOptions: Apollo.QueryHookOptions<GenerateModuleCurrencyApprovalDataData, GenerateModuleCurrencyApprovalDataVariables>): Apollo.QueryResult<GenerateModuleCurrencyApprovalDataData, Exact<{
    request: GenerateModuleCurrencyApprovalDataRequest;
}>>;
export declare function useGenerateModuleCurrencyApprovalDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GenerateModuleCurrencyApprovalDataData, GenerateModuleCurrencyApprovalDataVariables>): Apollo.LazyQueryResultTuple<GenerateModuleCurrencyApprovalDataData, Exact<{
    request: GenerateModuleCurrencyApprovalDataRequest;
}>>;
export type GenerateModuleCurrencyApprovalDataHookResult = ReturnType<typeof useGenerateModuleCurrencyApprovalData>;
...
export type GenerateModuleCurrencyApprovalDataQueryResult = Apollo.QueryResult<GenerateModuleCurrencyApprovalDataData, GenerateModuleCurrencyApprovalDataVariables>;
export declare const SupportedFollowModulesDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useSupportedFollowModules(baseOptions: Apollo.QueryHookOptions<SupportedFollowModulesData, SupportedFollowModulesVariables>): Apollo.QueryResult<SupportedFollowModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export declare function useSupportedFollowModulesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SupportedFollowModulesData, SupportedFollowModulesVariables>): Apollo.LazyQueryResultTuple<SupportedFollowModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export type SupportedFollowModulesHookResult = ReturnType<typeof useSupportedFollowModules>;
export type SupportedFollowModulesLazyQueryHookResult = ReturnType<typeof useSupportedFollowModulesLazyQuery>;
export type SupportedFollowModulesQueryResult = Apollo.QueryResult<SupportedFollowModulesData, SupportedFollowModulesVariables>;
export declare const SupportedReferenceModulesDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useSupportedReferenceModules(baseOptions: Apollo.QueryHookOptions<SupportedReferenceModulesData, SupportedReferenceModulesVariables>): Apollo.QueryResult<SupportedReferenceModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export declare function useSupportedReferenceModulesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SupportedReferenceModulesData, SupportedReferenceModulesVariables>): Apollo.LazyQueryResultTuple<SupportedReferenceModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export type SupportedReferenceModulesHookResult = ReturnType<typeof useSupportedReferenceModules>;
export type SupportedReferenceModulesLazyQueryHookResult = ReturnType<typeof useSupportedReferenceModulesLazyQuery>;
export type SupportedReferenceModulesQueryResult = Apollo.QueryResult<SupportedReferenceModulesData, SupportedReferenceModulesVariables>;
export declare const SupportedOpenActionModulesDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useSupportedOpenActionModules(baseOptions: Apollo.QueryHookOptions<SupportedOpenActionModulesData, SupportedOpenActionModulesVariables>): Apollo.QueryResult<SupportedOpenActionModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export declare function useSupportedOpenActionModulesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SupportedOpenActionModulesData, SupportedOpenActionModulesVariables>): Apollo.LazyQueryResultTuple<SupportedOpenActionModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export type SupportedOpenActionModulesHookResult = ReturnType<typeof useSupportedOpenActionModules>;
export type SupportedOpenActionModulesLazyQueryHookResult = ReturnType<typeof useSupportedOpenActionModulesLazyQuery>;
export type SupportedOpenActionModulesQueryResult = Apollo.QueryResult<SupportedOpenActionModulesData, SupportedOpenActionModulesVariables>;
export declare const SupportedOpenActionCollectModulesDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useSupportedOpenActionCollectModules(baseOptions: Apollo.QueryHookOptions<SupportedOpenActionCollectModulesData, SupportedOpenActionCollectModulesVariables>): Apollo.QueryResult<SupportedOpenActionCollectModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export declare function useSupportedOpenActionCollectModulesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SupportedOpenActionCollectModulesData, SupportedOpenActionCollectModulesVariables>): Apollo.LazyQueryResultTuple<SupportedOpenActionCollectModulesData, Exact<{
    request: SupportedModulesRequest;
}>>;
export type SupportedOpenActionCollectModulesHookResult = ReturnType<typeof useSupportedOpenActionCollectModules>;
export type SupportedOpenActionCollectModulesLazyQueryHookResult = ReturnType<typeof useSupportedOpenActionCollectModulesLazyQuery>;
export type SupportedOpenActionCollectModulesQueryResult = Apollo.QueryResult<SupportedOpenActionCollectModulesData, SupportedOpenActionCollectModulesVariables>;
...
export type ClaimProfileWithHandleMutationFn = Apollo.MutationFunction<ClaimProfileWithHandleData, ClaimProfileWithHandleVariables>;
/**
...
export type AddProfileInterestsMutationFn = Apollo.MutationFunction<AddProfileInterestsData, AddProfileInterestsVariables>;
/**
...
export type RemoveProfileInterestsMutationFn = Apollo.MutationFunction<RemoveProfileInterestsData, RemoveProfileInterestsVariables>;
/**
...
export type SetProfileMetadataMutationFn = Apollo.MutationFunction<SetProfileMetadataData, SetProfileMetadataVariables>;
/**
...
export type DismissRecommendedProfilesMutationFn = Apollo.MutationFunction<DismissRecommendedProfilesData, DismissRecommendedProfilesVariables>;
/**
...
export type CreateOnchainSetProfileMetadataTypedDataMutationFn = Apollo.MutationFunction<CreateOnchainSetProfileMetadataTypedDataData, CreateOnchainSetProfileMetadataTypedDataVariables>;
/**
...
export type CreateChangeProfileManagersTypedDataMutationFn = Apollo.MutationFunction<CreateChangeProfileManagersTypedDataData, CreateChangeProfileManagersTypedDataVariables>;
/**
...
export type CreateBlockProfilesTypedDataMutationFn = Apollo.MutationFunction<CreateBlockProfilesTypedDataData, CreateBlockProfilesTypedDataVariables>;
/**
...
export type CreateUnblockProfilesTypedDataMutationFn = Apollo.MutationFunction<CreateUnblockProfilesTypedDataData, CreateUnblockProfilesTypedDataVariables>;
/**
...
export type SetFollowModuleMutationFn = Apollo.MutationFunction<SetFollowModuleData, SetFollowModuleVariables>;
/**
...
export type LinkHandleToProfileMutationFn = Apollo.MutationFunction<LinkHandleToProfileData, LinkHandleToProfileVariables>;
/**
...
export type UnlinkHandleFromProfileMutationFn = Apollo.MutationFunction<UnlinkHandleFromProfileData, UnlinkHandleFromProfileVariables>;
/**
...
export type CreateLinkHandleToProfileTypedDataMutationFn = Apollo.MutationFunction<CreateLinkHandleToProfileTypedDataData, CreateLinkHandleToProfileTypedDataVariables>;
/**
...
export type CreateUnlinkHandleFromProfileTypedDataMutationFn = Apollo.MutationFunction<CreateUnlinkHandleFromProfileTypedDataData, CreateUnlinkHandleFromProfileTypedDataVariables>;
/**
...
export type CreateOnchainPostTypedDataMutationFn = Apollo.MutationFunction<CreateOnchainPostTypedDataData, CreateOnchainPostTypedDataVariables>;
/**
...
export type CreateOnchainCommentTypedDataMutationFn = Apollo.MutationFunction<CreateOnchainCommentTypedDataData, CreateOnchainCommentTypedDataVariables>;
/**
...
export type CreateOnchainMirrorTypedDataMutationFn = Apollo.MutationFunction<CreateOnchainMirrorTypedDataData, CreateOnchainMirrorTypedDataVariables>;
/**
...
export type CreateOnchainQuoteTypedDataMutationFn = Apollo.MutationFunction<CreateOnchainQuoteTypedDataData, CreateOnchainQuoteTypedDataVariables>;
/**
...
export type CreateMomokaPostTypedDataMutationFn = Apollo.MutationFunction<CreateMomokaPostTypedDataData, CreateMomokaPostTypedDataVariables>;
/**
...
export type CreateMomokaCommentTypedDataMutationFn = Apollo.MutationFunction<CreateMomokaCommentTypedDataData, CreateMomokaCommentTypedDataVariables>;
/**
...
export type CreateMomokaMirrorTypedDataMutationFn = Apollo.MutationFunction<CreateMomokaMirrorTypedDataData, CreateMomokaMirrorTypedDataVariables>;
/**
...
export type CreateMomokaQuoteTypedDataMutationFn = Apollo.MutationFunction<CreateMomokaQuoteTypedDataData, CreateMomokaQuoteTypedDataVariables>;
/**
...
export type CommentOnchainMutationFn = Apollo.MutationFunction<CommentOnchainData, CommentOnchainVariables>;
/**
...
export type MirrorOnchainMutationFn = Apollo.MutationFunction<MirrorOnchainData, MirrorOnchainVariables>;
/**
...
export type QuoteOnchainMutationFn = Apollo.MutationFunction<QuoteOnchainData, QuoteOnchainVariables>;
/**
 * __useQuoteOnchain__
 *
...
export type PostOnMomokaMutationFn = Apollo.MutationFunction<PostOnMomokaData, PostOnMomokaVariables>;
/**
 * __usePostOnMomoka__
 *
...
export type CommentOnMomokaMutationFn = Apollo.MutationFunction<CommentOnMomokaData, CommentOnMomokaVariables>;
/**
...
export type MirrorOnMomokaMutationFn = Apollo.MutationFunction<MirrorOnMomokaData, MirrorOnMomokaVariables>;
/**
...
export type QuoteOnMomokaMutationFn = Apollo.MutationFunction<QuoteOnMomokaData, QuoteOnMomokaVariables>;
/**
...
export type LegacyCollectMutationFn = Apollo.MutationFunction<LegacyCollectData, LegacyCollectVariables>;
/**
...
export type CreateLegacyCollectTypedDataMutationFn = Apollo.MutationFunction<CreateLegacyCollectTypedDataData, CreateLegacyCollectTypedDataVariables>;
/**
...
export type RefreshPublicationMetadataMutationFn = Apollo.MutationFunction<RefreshPublicationMetadataData, RefreshPublicationMetadataVariables>;
/**
...
export type AddPublicationBookmarkMutationFn = Apollo.MutationFunction<AddPublicationBookmarkData, AddPublicationBookmarkVariables>;
/**
...
export type RemovePublicationBookmarkMutationFn = Apollo.MutationFunction<RemovePublicationBookmarkData, RemovePublicationBookmarkVariables>;
/**
...
export type AddPublicationNotInterestedMutationFn = Apollo.MutationFunction<AddPublicationNotInterestedData, AddPublicationNotInterestedVariables>;
/**
...
export type UndoPublicationNotInterestedMutationFn = Apollo.MutationFunction<UndoPublicationNotInterestedData, UndoPublicationNotInterestedVariables>;
/**
...
export type BroadcastOnMomokaMutationFn = Apollo.MutationFunction<BroadcastOnMomokaData, BroadcastOnMomokaVariables>;
/**
...
export type CommentKeySpecifier = ('by' | 'commentOn' | 'createdAt' | 'firstComment' | 'hashtagsMentioned' | 'id' | 'isEncrypted' | 'isHidden' | 'metadata' | 'momoka' | 'openActionModules' | 'operations' | 'profilesMentioned' | 'publishedOn' | 'referenceModule' | 'root' | 'stats' | 'txHash' | CommentKeySpecifier)[];
...
export type HandleInfoKeySpecifier = ('fullHandle' | 'id' | 'linkedTo' | 'localName' | 'namespace' | 'ownedBy' | 'suggestedFormatted' | HandleInfoKeySpecifier)[];
...
export type ImageTransformParamKeySpecifier = ('height' | 'keepAspectRatio' | 'width' | ImageTransformParamKeySpecifier)[];
...
export type MutationKeySpecifier = ('actOnOpenAction' | 'addProfileInterests' | 'addPublicationBookmark' | 'addPublicationNotInterested' | 'addReaction' | 'authenticate' | 'block' | 'broadcastOnMomoka' | 'broadcastOnchain' | 'claimProfileWithHandle' | 'commentOnMomoka' | 'commentOnchain' | 'createActOnOpenActionTypedData' | 'createBlockProfilesTypedData' | 'createChangeProfileManagersTypedData' | 'createFollowTypedData' | 'createLegacyCollectTypedData' | 'createLinkHandleToProfileTypedData' | 'createMomokaCommentTypedData' | 'createMomokaMirrorTypedData' | 'createMomokaPostTypedData' | 'createMomokaQuoteTypedData' | 'createNftGallery' | 'createOnchainCommentTypedData' | 'createOnchainMirrorTypedData' | 'createOnchainPostTypedData' | 'createOnchainQuoteTypedData' | 'createOnchainSetProfileMetadataTypedData' | 'createProfile' | 'createProfileWithHandle' | 'createSetFollowModuleTypedData' | 'createUnblockProfilesTypedData' | 'createUnfollowTypedData' | 'createUnlinkHandleFromProfileTypedData' | 'deleteNftGallery' | 'dismissRecommendedProfiles' | 'follow' | 'hidePublication' | 'idKitPhoneVerifyWebhook' | 'internalAddCuratedTag' | 'internalAddInvites' | 'internalAllowDomain' | 'internalClaim' | 'internalCuratedUpdate' | 'internalNftIndex' | 'internalNftVerify' | 'internalRemoveCuratedTag' | 'internalUpdateModuleOptions' | 'internalUpdateProfileStatus' | 'invite' | 'legacyCollect' | 'linkHandleToProfile' | 'mirrorOnMomoka' | 'mirrorOnchain' | 'nftOwnershipChallenge' | 'postOnMomoka' | 'postOnchain' | 'quoteOnMomoka' | 'quoteOnchain' | 'refresh' | 'refreshPublicationMetadata' | 'removeProfileInterests' | 'removePublicationBookmark' | 'removeReaction' | 'reportProfile' | 'reportPublication' | 'revokeAuthentication' | 'setDefaultProfile' | 'setFollowModule' | 'setProfileMetadata' | 'unblock' | 'undoPublicationNotInterested' | 'unfollow' | 'unlinkHandleFromProfile' | 'updateNftGalleryInfo' | 'updateNftGalleryItems' | 'updateNftGalleryOrder' | 'walletAuthenticationToProfileAuthentication' | MutationKeySpecifier)[];
...
export type PaginatedResultInfoKeySpecifier = ('moreAfter' | 'next' | 'prev' | PaginatedResultInfoKeySpecifier)[];
...
export type ProfileKeySpecifier = ('createdAt' | 'followModule' | 'followNftAddress' | 'guardian' | 'handle' | 'id' | 'interests' | 'invitedBy' | 'invitesLeft' | 'metadata' | 'onchainIdentity' | 'operations' | 'ownedBy' | 'signless' | 'sponsor' | 'stats' | 'txHash' | ProfileKeySpecifier)[];
...
export type ProfileStatsKeySpecifier = ('comments' | 'countOpenActions' | 'followers' | 'following' | 'id' | 'mirrors' | 'posts' | 'publications' | 'quotes' | 'reacted' | 'reactions' | ProfileStatsKeySpecifier)[];
...
export type QueryKeySpecifier = ('approvedAuthentications' | 'approvedModuleAllowanceAmount' | 'canClaim' | 'challenge' | 'claimableProfiles' | 'claimableStatus' | 'currencies' | 'currentSession' | 'defaultProfile' | 'exploreProfiles' | 'explorePublications' | 'feed' | 'feedHighlights' | 'followRevenues' | 'followStatusBulk' | 'followers' | 'following' | 'fxRateFor' | 'generateModuleCurrencyApprovalData' | 'handleToAddress' | 'imageMediumSize' | 'imageSmallSize' | 'internalAllowedDomains' | 'internalClaimStatus' | 'internalCuratedHandles' | 'internalCuratedTags' | 'internalInvites' | 'internalProfileStatus' | 'invitedProfiles' | 'lastLoggedInProfile' | 'latestPaidActions' | 'lensAPIOwnedEOAs' | 'lensProtocolVersion' | 'lensTransactionStatus' | 'moduleMetadata' | 'momokaSubmitters' | 'momokaSummary' | 'momokaTransaction' | 'momokaTransactions' | 'mutualFollowers' | 'mutualNftCollections' | 'mutualPoaps' | 'nftCollectionOwners' | 'nftCollections' | 'nftGalleries' | 'nfts' | 'notifications' | 'ownedHandles' | 'ping' | 'poapEvent' | 'poapHolders' | 'poaps' | 'popularNftCollections' | 'profile' | 'profileActionHistory' | 'profileAlreadyInvited' | 'profileCoverSize' | 'profileInterestsOptions' | 'profileManagers' | 'profilePictureSize' | 'profileRecommendations' | 'profiles' | 'profilesManaged' | 'publication' | 'publicationBookmarks' | 'publications' | 'publicationsTags' | 'relayQueues' | 'revenueFromPublication' | 'revenueFromPublications' | 'searchProfiles' | 'searchPublications' | 'supportedFollowModules' | 'supportedOpenActionCollectModules' | 'supportedOpenActionModules' | 'supportedReferenceModules' | 'txIdToTxHash' | 'userSigNonces' | 'validatePublicationMetadata' | 'verify' | 'whoActedOnPublication' | 'whoHaveBlocked' | 'whoReactedPublication' | QueryKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
    ...
    ImageTransformParam?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
        keyFields?: false | ImageTransformParamKeySpecifier | (() => undefined | ImageTransformParamKeySpecifier);
