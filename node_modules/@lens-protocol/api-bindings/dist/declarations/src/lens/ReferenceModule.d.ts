...
export type ReferencePolicy = FollowersOnlyReferencePolicy | DegreesOfSeparationReferencePolicy | NoReferencePolicy | AnyoneReferencePolicy | UnknownReferencePolicy;
/**
 ...
 */
export declare function resolveReferencePolicy(publication: AnyPublication): ReferencePolicy;
