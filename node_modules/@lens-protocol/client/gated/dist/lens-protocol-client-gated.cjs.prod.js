...
var environments = require('../../dist/environments-af93e3ca.cjs.prod.js');
...
var LensClient = /*#__PURE__*/function (_base$LensClient) {
  environments._inherits(LensClient, _base$LensClient);
...
exports.decodeData = environments.decodeData;
exports.development = environments.development;
exports.encodeData = environments.encodeData;
...
exports.isValidProfileHandle = environments.isValidProfileHandle;
