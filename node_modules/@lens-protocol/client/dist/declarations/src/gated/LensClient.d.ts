import { AuthenticationConfig, IEncryptionProvider, ISigner } from '@lens-protocol/gated-content';
import * as base from "../LensClient.js";
 ...
 * ```
 */
export declare class LensClient extends base.LensClient {
    private _gated;
