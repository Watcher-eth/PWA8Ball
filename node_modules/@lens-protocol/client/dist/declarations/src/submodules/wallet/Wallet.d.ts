...
import type { ClaimProfileWithHandleRequest, CreateProfileWithHandleRequest, LastLoggedInProfileRequest, OwnedHandlesRequest, ProfilesManagedRequest } from "../../graphql/types.generated.js";
import { PaginatedResult } from "../../helpers/index.js";
import { ClaimableProfilesResultFragment, ClaimProfileWithHandleErrorResultFragment, CreateProfileWithHandleErrorResultFragment, UserSigNoncesFragment } from "./graphql/wallet.generated.js";
/**
...
export declare class Wallet {
     ...
     * ```
     */
    createProfile(request: CreateProfileWithHandleRequest): Promise<RelaySuccessFragment | CreateProfileWithHandleErrorResultFragment>;
    /**
