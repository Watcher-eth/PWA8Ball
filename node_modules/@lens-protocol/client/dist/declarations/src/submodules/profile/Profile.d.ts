...
import type { BlockRequest, ChangeProfileManagersRequest, CreateProfileWithHandleRequest, DefaultProfileRequest, DismissRecommendedProfilesRequest, FollowersRequest, FollowingRequest, FollowRequest, LinkHandleToProfileRequest, MutualFollowersRequest, OnchainSetProfileMetadataRequest, ProfileActionHistoryRequest, ProfileInterestsRequest, ProfileManagersRequest, ProfileRecommendationsRequest, ProfileRequest, ProfilesRequest, SetDefaultProfileRequest, SetFollowModuleRequest, TypedDataOptions, UnblockRequest, UnfollowRequest, UnlinkHandleFromProfileRequest, WhoActedOnPublicationRequest, WhoHaveBlockedRequest } from "../../graphql/types.generated.js";
import { PaginatedResult } from "../../helpers/index.js";
import { CreateBlockProfilesBroadcastItemResultFragment, CreateChangeProfileManagersBroadcastItemResultFragment, CreateFollowBroadcastItemResultFragment, CreateLinkHandleToProfileBroadcastItemResultFragment, CreateUnlinkHandleFromProfileBroadcastItemResultFragment, CreateOnchainSetProfileMetadataBroadcastItemResultFragment, CreateProfileWithHandleErrorResultFragment, CreateSetFollowModuleBroadcastItemResultFragment, CreateUnblockProfilesBroadcastItemResultFragment, CreateUnfollowBroadcastItemResultFragment, ProfileActionHistoryFragment, ProfileManagerFragment } from "./graphql/profile.generated.js";
...
export declare class Profile {
     ...
     * ```
     */
    create(request: CreateProfileWithHandleRequest): Promise<RelaySuccessFragment | CreateProfileWithHandleErrorResultFragment>;
    /**
