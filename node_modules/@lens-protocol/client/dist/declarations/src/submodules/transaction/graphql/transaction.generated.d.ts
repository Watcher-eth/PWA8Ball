...
export type LensTransactionStatusQuery = {
    result: LensTransactionResultFragment | null;
};
...
export declare const LensTransactionResultFragmentDoc: DocumentNode;
...
export declare const LensTransactionStatusDocument: DocumentNode;
...
export declare function getSdk(client: GraphQLClient, withWrapper?: SdkFunctionWrapper): {
    ...
    LensTransactionStatus(variables: LensTransactionStatusQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{
