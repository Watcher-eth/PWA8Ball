...
export declare class Actions {
     ...
     * ```
     */
    actOn(request: ActOnOpenActionRequest): PromiseResult<RelaySuccessFragment | LensProfileManagerRelayErrorFragment, CredentialsExpiredError | NotAuthenticatedError>;
    /**
