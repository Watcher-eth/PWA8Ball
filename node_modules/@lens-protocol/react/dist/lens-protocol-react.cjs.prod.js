  ...
  _createClass(PublicationCacheManager, [{
    ...
    value: function update(publicationId, updateFn) {
      this.client.cache.updateFragment({
        ...
        fragment: gql.FragmentAnyPublicationInternal,
...
function handleRelayError(error, _) {
  switch (error.reason) {
    ...
    case gql.LensProfileManagerRelayErrorReasonType.AppNotAllowed:
    ...
    case gql.LensProfileManagerRelayErrorReasonType.RateLimited:
    ...
    case gql.LensProfileManagerRelayErrorReasonType.NotSponsored:
    ...
    case gql.LensProfileManagerRelayErrorReasonType.Failed:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.UNKNOWN));
    case gql.LensProfileManagerRelayErrorReasonType.NoLensManagerEnabled:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.NO_LENS_MANAGER_ENABLED));
    case gql.LensProfileManagerRelayErrorReasonType.RequiresSignature:
...
var ReferrersSchema = zod.z.union([PublicationIdSchema, ProfileIdSchema]).array().min(1);
...
var UnknownReferencePolicyConfigSchema = zod.z.object({
  type: zod.z.literal(publications.ReferencePolicyType.UNKNOWN),
  address: EvmAddressSchema,
  data: DataSchema
});
var ReferencePolicyConfigSchema = zod.z.discriminatedUnion('type', [AnyoneReferencePolicyConfigSchema, DegreesOfSeparationReferencePolicyConfigSchema, FollowersOnlyReferencePolicyConfigSchema, NoReferencePolicyConfigSchema, UnknownReferencePolicyConfigSchema]);
...
var lensHubTransactionKinds = [entities.TransactionKind.ACT_ON_PUBLICATION, entities.TransactionKind.CREATE_COMMENT, entities.TransactionKind.CREATE_POST, entities.TransactionKind.CREATE_QUOTE, entities.TransactionKind.FOLLOW_PROFILE, entities.TransactionKind.MIRROR_PUBLICATION, entities.TransactionKind.UNFOLLOW_PROFILE, entities.TransactionKind.UPDATE_FOLLOW_POLICY, entities.TransactionKind.UPDATE_PROFILE_DETAILS, entities.TransactionKind.UPDATE_PROFILE_MANAGERS];
var tokenHandleRegistryTransactionKinds = [entities.TransactionKind.LINK_HANDLE, entities.TransactionKind.UNLINK_HANDLE];
var transactionKindToFilterGroup = (_transactionKindToFil = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, entities.TransactionKind.ACT_ON_PUBLICATION, lensHubTransactionKinds), entities.TransactionKind.BLOCK_PROFILE, lensHubTransactionKinds), entities.TransactionKind.CREATE_COMMENT, lensHubTransactionKinds), entities.TransactionKind.CREATE_POST, lensHubTransactionKinds), entities.TransactionKind.CREATE_QUOTE, lensHubTransactionKinds), entities.TransactionKind.FOLLOW_PROFILE, lensHubTransactionKinds), entities.TransactionKind.MIRROR_PUBLICATION, lensHubTransactionKinds), entities.TransactionKind.UNBLOCK_PROFILE, lensHubTransactionKinds), entities.TransactionKind.UNFOLLOW_PROFILE, lensHubTransactionKinds), entities.TransactionKind.UPDATE_FOLLOW_POLICY, lensHubTransactionKinds), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, entities.TransactionKind.UPDATE_PROFILE_DETAILS, lensHubTransactionKinds), entities.TransactionKind.UPDATE_PROFILE_MANAGERS, lensHubTransactionKinds), entities.TransactionKind.LINK_HANDLE, tokenHandleRegistryTransactionKinds), entities.TransactionKind.UNLINK_HANDLE, tokenHandleRegistryTransactionKinds), entities.TransactionKind.CLAIM_HANDLE, []), entities.TransactionKind.APPROVE_MODULE, []), entities.TransactionKind.CREATE_PROFILE, []));
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return this.apolloClient.refetchQueries({
                include: [gql.OwnedHandlesDocument, gql.ProfilesManagedDocument]
              });
            case 2:
            case "end":
              return _context.stop();
...
function resolveTransactionErrorReason(reason) {
  switch (reason) {
    case gql.LensTransactionFailureType.Reverted:
                    ...
                    var _next = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref) {
                      ...
                      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                        while (1) switch (_context2.prev = _context2.next) {
                          ...
                          case 3:
                            if (!(result.status === gql.LensTransactionStatusType.Failed)) {
                              _context2.next = 7;
                              break;
                            }
                          ...
                          case 7:
                            ...
                            if (!(previousTxHash !== result.txHash || result.status === gql.LensTransactionStatusType.Complete)) {
                              _context2.next = 12;
                              break;
                            }
                            subscription.unsubscribe();
                            resolve(sharedKernel.success({
                              indexed: result.status === gql.LensTransactionStatusType.Complete,
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 12:
              ...
              return _context3.abrupt("return", sharedKernel.success(_signature3));
            case 16:
              _context3.prev = 16;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              return _context4.abrupt("return", sharedKernel.failure(new entities.PendingSigningRequestError()));
            case 7:
              this.signingInProgress = true;
              signer = result.value;
              _context4.prev = 9;
            ...
            case 12:
              ...
              return _context4.abrupt("return", sharedKernel.success(transaction));
            case 17:
              _context4.prev = 17;
              ...
              return _context4.abrupt("return", sharedKernel.failure(new entities.UserRejectedError()));
            case 22:
              if (!(_context4.t0.code === logger.ErrorCode.INSUFFICIENT_FUNDS)) {
                _context4.next = 24;
                break;
              }
              return _context4.abrupt("return", sharedKernel.failure(new entities.InsufficientGasError(sharedKernel.matic())));
            case 24:
              throw _context4.t0;
            case 25:
              _context4.prev = 25;
  ...
  var execute = React.useCallback( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(input) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(!state.loading, 'Cannot execute a task while another is in progress.');
...
function useLazyFragmentVariables() {
  ...
  return React.useCallback(function (variables) {
...
function useSession(args) {
  ...
  var update = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(newSessionData) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(newSessionData, 'Session data must be defined.');
            if (!(newSessionData.type === authentication.SessionType.WithProfile)) {
              _context.next = 8;
              break;
            }
            _context.next = 4;
          ...
          case 4:
            ...
            return _context.abrupt("return");
          case 7:
            sharedKernel.invariant(response.data, 'Cannot fetch profile data');
          case 8:
          case "end":
            return _context.stop();
        }
  ...
  React.useEffect(function () {
    if (result.loading) {
      if ((sessionData === null || sessionData === void 0 ? void 0 : sessionData.type) === authentication.SessionType.WithProfile) {
        void update(sessionData);
        return;
      }
      return gql.sessionDataVar.onNextChange( /*#__PURE__*/function () {
  ...
  if (args !== null && args !== void 0 && args.suspense) {
    if (result.loading) {
      ...
      throw new Promise(function (resolve) {
        gql.sessionDataVar.onNextChange( /*#__PURE__*/function () {
...
function useProfileFromCache(data) {
  ...
  var shouldFetchProfile = (data === null || data === void 0 ? void 0 : data.type) === authentication.SessionType.WithProfile;
  var profileId = (data === null || data === void 0 ? void 0 : data.type) === authentication.SessionType.WithProfile ? data.profileId : undefined;
  var _useProfile = gql.useProfile(useLensApolloClient({
...
function resultFrom(sessionData, _ref3) {
  ...
  if (!sessionData || sessionData.type === authentication.SessionType.WithProfile && !profile && !previousProfile) {
    return {
      data: undefined,
      error: undefined,
      loading: true
  ...
  switch (sessionData.type) {
    ...
    case authentication.SessionType.WithProfile:
      return {
        data: {
          type: authentication.SessionType.WithProfile,
          authenticated: true,
          address: sessionData.address,
          profile: (_ref4 = profile !== null && profile !== void 0 ? profile : previousProfile) !== null && _ref4 !== void 0 ? _ref4 : sharedKernel.never('This should never happen.')
        },
        error: undefined,
        loading: false
      };
...
function useSuspendableQuery(args) {
  if (args.suspense) {
    return useSuspenseResult(client.useSuspenseQuery(args.query, args.options));
  }
  return useReadResult(client.useQuery(args.query, args.options));
}
...
function useSuspendablePaginatedQuery(args) {
  if (args.suspense) {
    return useSuspensePaginatedResult(client.useSuspenseQuery(args.query, args.options));
  }
  return usePaginatedReadResult(client.useQuery(args.query, args.options));
}
...
function useExploreProfiles() {
  ...
  return useSuspendablePaginatedQuery({
    suspense: suspense,
    query: gql.ExploreProfilesDocument,
...
function useExplorePublications() {
  ...
  return useSuspendablePaginatedQuery({
    suspense: suspense,
    query: gql.ExplorePublicationsDocument,
    options: useLensApolloClient({
      variables: useFragmentVariables({
        where: where,
        orderBy: orderBy,
...
function useFeed(_ref) {
  ...
  return useSuspendablePaginatedQuery({
    ...
    options: useLensApolloClient({
      ...
      skip: session.type !== authentication.SessionType.WithProfile
    })
  });
}
...
function useFeedHighlights(_ref) {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(gql.useFeedHighlights(useLensApolloClient({
    variables: useFragmentVariables({
      where: where,
      statsFor: where === null || where === void 0 || (_where$metadata = where.metadata) === null || _where$metadata === void 0 ? void 0 : _where$metadata.publishedOn
    }),
...
function useRecommendedProfiles(_ref) {
  ...
  return useSuspendablePaginatedQuery({
    suspense: suspense,
    query: gql.ProfileRecommendationsDocument,
    options: useLensApolloClient({
...
function useSearchProfiles(_ref) {
  ...
  return useSuspendablePaginatedQuery({
    suspense: suspense,
    query: gql.SearchProfilesDocument,
    options: useLensApolloClient({
      variables: useFragmentVariables(args)
    })
  });
...
function useSearchPublications(_ref) {
  ...
  return useSuspendablePaginatedQuery({
    suspense: suspense,
    query: gql.SearchPublicationsDocument,
    options: useLensApolloClient({
      variables: useFragmentVariables({
        query: query,
        limit: limit,
...
function useCredentials() {
  ...
  var credentials = React.useSyncExternalStore(adapter.subscribe, adapter.get);
  return credentials;
}
...
function useCurrencies() {
  var _result$data;
  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var result = usePaginatedReadResult(gql.useCurrencies(useLensApolloClient({
    variables: args
  })));
  if (result.loading) {
    return result;
...
function useInvitedProfiles() {
  ...
  return useReadResult(gql.useInvitedProfiles(useLensApolloClient({
    variables: useFragmentVariables()
  })));
}
...
function useLatestPaidActions() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    filter = _ref.filter,
    where = _ref.where;
  return usePaginatedReadResult(gql.useLatestPaidActions(useLensApolloClient({
    variables: useFragmentVariables({
      filter: filter,
      where: where
    })
...
function useModuleMetadata(args) {
  return useReadResult(gql.useModuleMetadata(useLensApolloClient({
    variables: {
      request: args
    }
  })));
...
function useLazyModuleMetadata() {
  var _useModuleMetadataLaz = gql.useModuleMetadataLazyQuery(useLensApolloClient({
...
function useResolveAddress() {
  var _useHandleToAddressLa = gql.useHandleToAddressLazyQuery(useLensApolloClient()),
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.SignFrameActionDocument,
                variables: {
            ...
            case 3:
              result = _context.sent;
              return _context.abrupt("return", gql.omitTypename(result.data.result));
            case 5:
            case "end":
              return _context.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.apolloClient.query({
                query: gql.CreateFrameTypedDataDocument,
                variables: {
                  request: request
                }
              });
            case 2:
              result = _context2.sent;
              return _context2.abrupt("return", {
                data: gql.omitTypename(result.data.result)
              });
            case 4:
            case "end":
              return _context2.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            frameAction = new wallets.SignFrameAction(activeWallet, gateway, presenter);
            _context.next = 5;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a profile. Use `useLogin` hook to authenticate.');
            _context.next = 3;
            return sign({
          ...
          case 3:
            ...
            return _context.abrupt("return", result);
          case 6:
            return _context.abrupt("return", sharedKernel.success(result.value));
          case 7:
          case "end":
            return _context.stop();
        }
...
function useWasWalletInvited(args) {
  return useReadResult(gql.useProfileAlreadyInvited(useLensApolloClient({
    variables: {
      request: args
    }
  })));
...
function useLazyWasWalletInvited() {
  var _useProfileAlreadyInv = gql.useProfileAlreadyInvitedLazyQuery(useLensApolloClient()),
...
function useNotifications() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    where = _ref.where;
  return usePaginatedReadResult(gql.useNotifications(useLensApolloClient({
    variables: useFragmentVariables({
      where: where,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.AddProfileInterestsDocument,
                variables: {
                  request: {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.RemoveProfileInterestsDocument,
                variables: {
                  request: {
                    interests: request.interests
                  }
  ...
  var add = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a profile to use this hook. Use `useLogin` hook to authenticate.');
            ...
            manageInterests = new profile.ManageProfileInterests(gateway, presenter);
            _context.next = 6;
...
function useBlockedProfiles() {
  ...
  return usePaginatedReadResult(gql.useWhoHaveBlocked(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useLazyProfile() {
  var _useProfileLazyQuery = gql.useProfileLazyQuery(useLensApolloClient({
      fetchPolicy: 'cache-and-network'
    })),
...
function useLazyProfiles() {
  var _useProfilesLazyQuery = gql.useProfilesLazyQuery(useLensApolloClient({
      fetchPolicy: 'no-cache'
    })),
...
function useMutualFollowers(args) {
  return usePaginatedReadResult(gql.useMutualFollowers(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useProfile(_ref2) {
  ...
  sharedKernel.invariant(request.forProfileId === undefined || request.forHandle === undefined, "Only one of 'forProfileId' or 'forHandle' should be provided to 'useProfile' hook");
...
function useProfileActionHistory() {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(gql.useProfileActionHistory(useLensApolloClient({
    variables: args,
    skip: (session === null || session === void 0 ? void 0 : session.type) !== authentication.SessionType.WithProfile
  })));
}
...
function useProfileManagers(args) {
  return usePaginatedReadResult(gql.useProfileManagers(useLensApolloClient({
    variables: {
      request: args
    }
  })));
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.PeerToPeerRecommendDocument,
                variables: {
                  request: {
                    profileId: id
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.PeerToPeerUnrecommendDocument,
                variables: {
                  request: {
                    profileId: id
                  }
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            toggle = new profile.ToggleProfileProperty(gateway, presenter);
            _context.next = 5;
...
function useWhoActedOnPublication(args) {
  return usePaginatedReadResult(gql.useWhoActedOnPublication(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useBookmarks() {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(gql.usePublicationBookmarks(useLensApolloClient({
    variables: useFragmentVariables({
      request: args,
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            toggle = new publications.TogglePublicationProperty(gateway, presenter);
            _context.next = 5;
            return toggle.on(request);
          case 5:
          case "end":
...
function useLazyPublication() {
  var _usePublicationLazyQu = gql.usePublicationLazyQuery(useLensApolloClient({
      fetchPolicy: 'cache-and-network'
    })),
...
function useLazyPublications() {
  var _usePublicationsLazyQ = gql.usePublicationsLazyQuery(useLensApolloClient({
      fetchPolicy: 'no-cache'
    })),
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            publication = _ref.publication;
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            _ref3 = gql.isMirrorPublication(publication) ? publication.mirrorOn : publication, id = _ref3.id, isNotInterested = _ref3.operations.isNotInterested;
            if (!isNotInterested) {
              _context.next = 8;
              break;
            }
...
function usePublication(_ref2) {
  ...
  sharedKernel.invariant(request.forId === undefined || request.forTxHash === undefined, "Only one of 'forId' or 'forTxHash' should be provided to 'usePublication' hook");
  var result = useSuspendableQuery({
    suspense: suspense,
    query: gql.PublicationDocument,
    options: useLensApolloClient({
...
function usePublications(_ref) {
  ...
  return useSuspendablePaginatedQuery({
    suspense: suspense,
    query: gql.PublicationsDocument,
    options: useLensApolloClient({
      variables: useFragmentVariables({
        where: where,
        limit: limit,
...
function useWhoReactedToPublication(args) {
  return usePaginatedReadResult(gql.useWhoReactedPublication(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useRevenueFromFollow(args) {
  var _useReadResult = useReadResult(gql.useFollowRevenues(useLensApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
function useRevenueFromPublication(args) {
  var _useReadResult = useReadResult(gql.useRevenueFromPublication(useLensApolloClient({
      variables: useFragmentVariables({
        request: args,
...
function useRevenueFromPublications(args) {
  return usePaginatedReadResult(gql.useRevenueFromPublications(useLensApolloClient({
...
var UnsignedContractCallTransaction = /*#__PURE__*/function (_ref) {
  ...
  function UnsignedContractCallTransaction(request, transactionRequest) {
    ...
    _this = _super.call(this, uuid.v4(), sharedKernel.ChainType.POLYGON, request);
...
function resolveReferenceModuleInput(config) {
  switch (config.type) {
    ...
    case publications.ReferencePolicyType.UNKNOWN:
      return {
...
var CreateOnChainCommentGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(CreateOnChainCommentGateway, [{
    ...
    value: function createCommentCallDetails(result) {
      var contract = blockchainBindings.lensHub(result.typedData.domain.verifyingContract);
...
function extractUnknownReferenceModuleAddress(reference) {
  ...
  if (reference.type !== publications.ReferencePolicyType.UNKNOWN) {
    return [];
  }
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            if (!(referencedPublicationId && entities.isMomokaPublicationId(referencedPublicationId))) {
              _context.next = 7;
              break;
            }
            return _context.abrupt("return", {
          ...
          case 10:
            ...
            sharedKernel.invariant(gql.isPrimaryPublication(publication), "Referenced publication ".concat(referencedPublicationId, " is not a primary publication: ").concat(publication.__typename));
            referencePolicy = gql.resolveReferencePolicy(publication);
            if (!(referencePolicy.type === publications.ReferencePolicyType.UNKNOWN)) {
              _context.next = 17;
              break;
            }
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a Profile to comment. Use `useLogin` hook to authenticate.');
            _context.next = 3;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a Profile to mirror. Use `useLogin` hook to authenticate.');
            _context.next = 3;
            return resolveExecutionMode({
              author: session.profile,
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a Profile to quote. Use `useLogin` hook to authenticate.');
            _context.next = 3;
            return resolveExecutionMode({
              actions: args.actions,
              author: session.profile,
...
var LinkedResourcesPaths = (_LinkedResourcesPaths = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_LinkedResourcesPaths, metadata.PublicationSchemaId.ARTICLE_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.AUDIO_LATEST, ['lens.audio.item', 'lens.audio.cover', 'lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.CHECKING_IN_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.EMBED_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.EVENT_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.IMAGE_LATEST, ['lens.image.item', 'lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.LINK_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.LIVESTREAM_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.MINT_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.SPACE_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_LinkedResourcesPaths, metadata.PublicationSchemaId.STORY_LATEST, ['lens.asset.item', 'lens.asset.cover']), metadata.PublicationSchemaId.TEXT_ONLY_LATEST, []), metadata.PublicationSchemaId.THREE_D_LATEST, ['lens.assets[n].uri', 'lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.TRANSACTION_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), metadata.PublicationSchemaId.VIDEO_LATEST, ['lens.video.item', 'lens.video.cover', 'lens.attachments[n].item', 'lens.attachments[n].cover']));
      ...
      var _upload = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(metadata) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 11:
              return _context.abrupt("return", sharedKernel.success(uri));
            case 14:
              _context.prev = 14;
              ...
              return _context.abrupt("return", sharedKernel.failure(_context.t0));
            case 19:
              return _context.abrupt("return", sharedKernel.failure(new UploadError('Failed to upload metadata', {
                cause: _context.t0
              })));
            case 20:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return sharedKernel.update(metadata, paths, /*#__PURE__*/function () {
...
function publicationMetadataMedia(media) {
  switch (true) {
    case media.type in metadata__namespace.MediaAudioMimeType:
      return publicationMetadataMediaAudio(media);
    case media.type in metadata__namespace.MediaImageMimeType:
      return publicationMetadataMediaImage(media);
    case media.type in metadata__namespace.MediaVideoMimeType:
      return publicationMetadataMediaVideo(media);
  }
  sharedKernel.never(media.type);
}
function publicationMetadataTransactionType(type) {
  switch (type) {
    case metadata__namespace.MetadataTransactionType.ERC20:
      return gql__namespace.PublicationMetadataTransactionType.Erc20;
    case metadata__namespace.MetadataTransactionType.ERC721:
      return gql__namespace.PublicationMetadataTransactionType.Erc721;
    case metadata__namespace.MetadataTransactionType.OTHER:
    default:
      return gql__namespace.PublicationMetadataTransactionType.Other;
  }
}
function publicationMetadataLicenseType(license) {
  if (license in metadata__namespace.MetadataLicenseType) {
    return license;
  }
  return null;
}
function publicationMetadata(_ref) {
  ...
  var $schema = _ref.$schema,
    lens = _ref.lens;
  switch ($schema) {
    case metadata__namespace.PublicationSchemaId.ARTICLE_LATEST:
      return _objectSpread2({
        __typename: 'ArticleMetadataV3',
        title: (_lens$title = lens.title) !== null && _lens$title !== void 0 ? _lens$title : sharedKernel.never(),
    ...
    case metadata__namespace.PublicationSchemaId.TEXT_ONLY_LATEST:
      return _objectSpread2({
        __typename: 'TextOnlyMetadataV3',
        content: lens.content
      }, metadataCommon(lens));
    case metadata__namespace.PublicationSchemaId.IMAGE_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.VIDEO_LATEST:
      return _objectSpread2({
        ...
        isShortVideo: lens.mainContentFocus === metadata__namespace.PublicationMainFocus.SHORT_VIDEO,
    ...
    case metadata__namespace.PublicationSchemaId.AUDIO_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.TRANSACTION_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.EMBED_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.LINK_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.MINT_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.SPACE_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.LIVESTREAM_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.THREE_D_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.CHECKING_IN_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.EVENT_LATEST:
      return _objectSpread2({
    ...
    case metadata__namespace.PublicationSchemaId.STORY_LATEST:
      return _objectSpread2({
...
function post(_ref2) {
  ...
  return {
    ...
    operations: {
      ...
      id: id,
      canCollect: gql__namespace.TriStateValue.No,
      canComment: gql__namespace.TriStateValue.No,
      canDecrypt: {
      ...
      hasBookmarked: false,
      hasReported: false,
      canMirror: gql__namespace.TriStateValue.No,
      canQuote: gql__namespace.TriStateValue.No,
      hasMirrored: false,
      hasUpvoted: false,
      hasDownvoted: false,
      hasCollected: {
...
function useOptimisticCreatePost(uploader) {
  var metadataUploader = React.useMemo(function () {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              _context2.next = 4;
              return this.apolloClient.query({
                query: gql.GenerateLensApiRelayAddressDocument
              });
            case 4:
              _yield$this$apolloCli = _context2.sent;
              data = _yield$this$apolloCli.data;
...
var LinkHandleGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(LinkHandleGateway, [{
    ...
    value: function createLinkCallDetails(result) {
      var contract = blockchainBindings.lensTokenHandleRegistry(result.typedData.domain.verifyingContract);
...
var UpdateProfileManagersGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(UpdateProfileManagersGateway, [{
    ...
    value: function createChangeDelegatedExecutorsConfigCallDetails(data) {
      var contract = blockchainBindings.lensHub(data.typedData.domain.verifyingContract);
...
function useCanClaimHandle() {
  ...
  return useReadResult(gql.useClaimableProfiles(useLensApolloClient({
    fetchPolicy: 'network-only'
  })));
}
...
function useLastLoggedInProfile(args) {
  var _useReadResult = useReadResult(gql.useLastLoggedInProfile(useLensApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
function useLazyProfilesManaged() {
  var _useProfilesManagedLa = gql.useProfilesManagedLazyQuery(useLensApolloClient({
      fetchPolicy: 'no-cache'
    })),
...
function useOwnedHandles(args) {
  return usePaginatedReadResult(gql.useOwnedHandles(useLensApolloClient({
    variables: args
  })));
}
...
function useProfilesManaged(args) {
  return usePaginatedReadResult(gql.useProfilesManaged(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useRateLimits(args) {
  var _useReadResult = useReadResult(gql.useUserRateLimit(useLensApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
var development = {
  ...
  chains: _defineProperty(_defineProperty({}, sharedKernel.ChainType.ETHEREUM, goerli), sharedKernel.ChainType.POLYGON, amoy),
  timings: {
    pollingInterval: 3000,
...
Object.defineProperty(exports, 'CollectOpenActionModuleType', {
  enumerable: true,
  get: function () { return gql.CollectOpenActionModuleType; }
});
...
Object.defineProperty(exports, 'DecryptFailReasonType', {
  enumerable: true,
  get: function () { return gql.DecryptFailReasonType; }
});
...
Object.defineProperty(exports, 'ManagedProfileVisibility', {
  enumerable: true,
  get: function () { return gql.ManagedProfileVisibility; }
});
...
Object.defineProperty(exports, 'MetadataAttributeType', {
  enumerable: true,
  get: function () { return gql.MetadataAttributeType; }
});
Object.defineProperty(exports, 'ModuleType', {
  enumerable: true,
  get: function () { return gql.ModuleType; }
});
...
Object.defineProperty(exports, 'ProfilesOrderBy', {
  enumerable: true,
  get: function () { return gql.ProfilesOrderBy; }
});
...
Object.defineProperty(exports, 'isMultirecipientCollectFee', {
  enumerable: true,
  get: function () { return gql.isMultirecipientCollectFee; }
});
...
Object.defineProperty(exports, 'resolveCollectPolicy', {
  enumerable: true,
  get: function () { return gql.resolveCollectPolicy; }
});
...
Object.defineProperty(exports, 'TransactionErrorReason', {
  enumerable: true,
  get: function () { return entities.TransactionErrorReason; }
});
...
Object.defineProperty(exports, 'WalletConnectionErrorReason', {
  enumerable: true,
  get: function () { return entities.WalletConnectionErrorReason; }
});
...
Object.defineProperty(exports, 'WalletAlreadyInvitedError', {
  enumerable: true,
  get: function () { return wallets.WalletAlreadyInvitedError; }
});
...
Object.defineProperty(exports, 'ClaimHandleError', {
  enumerable: true,
  get: function () { return profile.ClaimHandleError; }
});
...
exports.useAddProfileInterests = useAddProfileInterests;
...
exports.useLatestPaidActions = useLatestPaidActions;
...
exports.useOptimisticCreatePost = useOptimisticCreatePost;
...
exports.useRateLimits = useRateLimits;
exports.useReactionToggle = useReactionToggle;
exports.useRecommendProfileToggle = useRecommendProfileToggle;
exports.useRecommendedProfiles = useRecommendedProfiles;
exports.useRefreshToken = useRefreshToken;
exports.useRemoveProfileInterests = useRemoveProfileInterests;
...
exports.useSignFrameAction = useSignFrameAction;
