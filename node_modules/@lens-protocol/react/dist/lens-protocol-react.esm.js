...
import { updateSessionData, AuthChallengeDocument, AuthAuthenticateDocument, AuthRefreshDocument, RevokeAuthenticationDocument, getSessionData, ProfileDocument, PublicationDocument, isPostPublication, isCommentPublication, isMirrorPublication, isQuotePublication, LensProfileManagerRelayErrorReasonType, RelayErrorReasonType, BroadcastOnMomokaDocument, BroadcastOnchainDocument, recentTransactionsVar, TxStatus, OwnedHandlesDocument, ProfileManagersDocument, LensTransactionStatusDocument, LensTransactionStatusType, LensTransactionFailureType, createAuthApolloClient, createLensApolloClient, defaultQueryParams, useSessionDataVar, useProfile as useProfile$1, UnspecifiedError, WalletAuthenticationToProfileAuthenticationDocument, DismissRecommendedProfilesDocument, ProfileRecommendationsDocument, ExploreProfilesOrderByType, useExploreProfiles as useExploreProfiles$1, ExplorePublicationsOrderByType, useExplorePublications as useExplorePublications$1, useFeed as useFeed$1, useFeedHighlights as useFeedHighlights$1, useProfileRecommendations, useSearchProfiles as useSearchProfiles$1, useSearchPublications as useSearchPublications$1, useCurrencies as useCurrencies$1, chainType, useInvitedProfiles as useInvitedProfiles$1, InviteDocument, ProfileAlreadyInvitedDocument, InvitedProfilesDocument, useModuleMetadata as useModuleMetadata$1, useModuleMetadataLazyQuery, useHandleToAddressLazyQuery, useProfileAlreadyInvited, useProfileAlreadyInvitedLazyQuery, useNotifications as useNotifications$1, useWhoHaveBlocked, useProfileLazyQuery, useProfilesLazyQuery, useMutualFollowers as useMutualFollowers$1, useProfileActionHistory as useProfileActionHistory$1, useFollowers, useFollowing, useProfileManagers as useProfileManagers$1, useProfiles as useProfiles$1, useWhoActedOnPublication as useWhoActedOnPublication$1, usePublicationBookmarks, AddPublicationBookmarkDocument, RemovePublicationBookmarkDocument, isPrimaryPublication, HidePublicationDocument, usePublicationLazyQuery, usePublicationsLazyQuery, AddPublicationNotInterestedDocument, UndoPublicationNotInterestedDocument, usePublication as usePublication$1, usePublications as usePublications$1, AddReactionDocument, RemoveReactionDocument, PublicationReactionType, ReportPublicationDocument, PublicationReportingReason, PublicationReportingSpamSubreason, PublicationReportingSensitiveSubreason, PublicationReportingFraudSubreason, PublicationReportingIllegalSubreason, useWhoReactedPublication, useFollowRevenues, useRevenueFromPublication as useRevenueFromPublication$1, useRevenueFromPublications as useRevenueFromPublications$1, resolveTokenAllowanceRequest, ClaimProfileWithHandleDocument, omitTypename, CommentOnMomokaDocument, CreateMomokaCommentTypedDataDocument, CommentOnchainDocument, CreateOnchainCommentTypedDataDocument, MirrorOnMomokaDocument, CreateMomokaMirrorTypedDataDocument, MirrorOnchainDocument, CreateOnchainMirrorTypedDataDocument, PostOnMomokaDocument, CreateMomokaPostTypedDataDocument, PostOnchainDocument, CreateOnchainPostTypedDataDocument, QuoteOnMomokaDocument, CreateMomokaQuoteTypedDataDocument, QuoteOnchainDocument, CreateOnchainQuoteTypedDataDocument, FollowDocument, CreateFollowTypedDataDocument, TriStateValue, resolveFollowPolicy, LinkHandleToProfileDocument, CreateLinkHandleToProfileTypedDataDocument, isPublicationId, LegacyCollectDocument, ActOnOpenActionDocument, resolveOpenActionRequestFor, SetProfileMetadataDocument, CreateOnchainSetProfileMetadataTypedDataDocument, UnfollowDocument, CreateUnfollowTypedDataDocument, UnlinkHandleFromProfileDocument, CreateUnlinkHandleFromProfileTypedDataDocument, SetFollowModuleDocument, CreateSetFollowModuleTypedDataDocument, CreateChangeProfileManagersTypedDataDocument, ChangeProfileManagerActionType, UnblockDocument, CreateUnblockProfilesTypedDataDocument, BlockDocument, CreateBlockProfilesTypedDataDocument, useClaimableProfiles, useLastLoggedInProfile as useLastLoggedInProfile$1, useOwnedHandles as useOwnedHandles$1, useProfilesManaged as useProfilesManaged$1, snapshotPoll, demoSnapshotPoll } from '@lens-protocol/api-bindings';
export { ClaimProfileWithHandleErrorReasonType, CommentRankingFilterType, ComparisonOperatorConditionType, CustomFiltersType, ExploreProfilesOrderByType, ExplorePublicationType, ExplorePublicationsOrderByType, FeedEventItemType, FollowModuleType, LimitType, MarketplaceMetadataAttributeDisplayType, NftContractType, NotificationType, OpenActionCategoryType, OpenActionKind, OpenActionModuleType, ProfileActionHistoryType, ProfileInterestTypes, PublicationContentWarningType, PublicationMetadataLicenseType, PublicationMetadataMainFocusType, PublicationMetadataTransactionType, PublicationReactionType, PublicationType, SearchPublicationType, TriStateValue, UnspecifiedError, defaultQueryParams, isCommentPublication, isMirrorPublication, isPostPublication, isPrimaryPublication, isQuotePublication, isValidHandle, resolveFollowPolicy } from '@lens-protocol/api-bindings';
import { TransactionKind, ProtocolTransactionKinds, MetaTransaction, NativeTransaction, DataTransaction, TransactionEvent, TransactionError, TransactionErrorReason, Wallet, UserRejectedError, PendingSigningRequestError, InsufficientGasError, WalletConnectionError, WalletConnectionErrorReason, ReportReason, UnsignedTransaction } from '@lens-protocol/domain/entities';
export { InsufficientGasError, PendingSigningRequestError, ReportReason, TransactionError, UserRejectedError, WalletConnectionError } from '@lens-protocol/domain/entities';
import { BroadcastingError, BroadcastingErrorReason, TokenAllowanceLimit, TransactionQueue, TokenAllowance, SignedOnChain, DelegableSigning, SubsidizeOffChain, PaidTransaction } from '@lens-protocol/domain/use-cases/transactions';
export { BroadcastingError, TokenAllowanceLimit } from '@lens-protocol/domain/use-cases/transactions';
import { TokenAvailability, InviteWallets } from '@lens-protocol/domain/use-cases/wallets';
export { InsufficientAllowanceError, InsufficientFundsError } from '@lens-protocol/domain/use-cases/wallets';
import { failure, success, invariant, DateUtils, never, InvariantError, assertError, ChainType, Kind, Amount, erc20, assertNever, BigDecimal, matic, Deferred, Denomination, hasAtLeastOne, hasTwoOrMore, ether } from '@lens-protocol/shared-kernel';
export { Amount, ChainType, InvariantError, WellKnownSymbols, erc20, ether, matic, usd } from '@lens-protocol/shared-kernel';
import jwtDecode from 'jwt-decode';
import isObject from 'lodash/isObject';
import { CredentialsStorageSchema, Storage, BaseStorageSchema } from '@lens-protocol/storage';
import { z } from 'zod';
import { FollowPolicyType, DismissRecommendedProfiles, isClaimReservedHandleRequest, ClaimHandleError as ClaimHandleError$1, ClaimHandle, isPaidFollowRequest, FollowProfile, LinkHandle, SetProfileMetadata, UnfollowProfile, UnlinkHandle, UpdateFollowPolicy, UpdateProfileManagers, UnblockProfiles, BlockProfiles } from '@lens-protocol/domain/use-cases/profile';
export { FollowPolicyType } from '@lens-protocol/domain/use-cases/profile';
import { OpenActionType, ReferencePolicyType, AllOpenActionType, ToggleProperty, HidePublication, ReportPublication, CreateComment, CreateMirror, CreatePost, CreateQuote, OpenAction } from '@lens-protocol/domain/use-cases/publications';
export { OpenActionType, ReferencePolicyType } from '@lens-protocol/domain/use-cases/publications';
import { erc20 as erc20$1, isTheSameAddress, bigNumber, lensHub, lensTokenHandleRegistry, publicActProxy } from '@lens-protocol/blockchain-bindings';
import { errors, utils, constants } from 'ethers';
...
var AccessTokenStorage = /*#__PURE__*/function () {
  ...
  _createClass(AccessTokenStorage, [{
    ...
    value: function () {
      var _refreshCredentials = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(credentials) {
        var newCredentials;
      ...
      function refreshCredentials(_x) {
...
var Credentials = /*#__PURE__*/function () {
  ...
  _createClass(Credentials, [{
    ...
    value: function isExpired() {
      ...
      var now = Date.now();
      var tokenExpDate = this.getTokenExpDate(accessToken);
      return now >= tokenExpDate - TOKEN_EXP_THRESHOLD;
    }
  }, {
    key: "getTokenExpDate",
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              return _context3.abrupt("return", new Credentials(newAccessToken, newRefreshToken));
            case 5:
            case "end":
...
var ProfileCacheManager = /*#__PURE__*/function () {
  function ProfileCacheManager(client) {
  ...
  _createClass(ProfileCacheManager, [{
    ...
    key: "fetch",
    value: function () {
      var _fetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(request, fetchPolicy) {
...
var PublicationCacheManager = /*#__PURE__*/function () {
  function PublicationCacheManager(client) {
...
var UriSchema = z.string().min(6).url().transform(function (value) {
  return value;
});
var EvmAddressSchema = z.string().min(42).transform(function (value) {
  return value;
});
var DataSchema = z.string().transform(function (value) {
  return value;
});
...
var FollowRequestSchema = z.union([PaidFollowRequestSchema, FreeFollowRequestSchema]);
...
var FollowPolicyConfigSchema = z.discriminatedUnion('type', [ChargeFollowPolicyConfigSchema, AnyoneFollowPolicyConfigSchema, NoOneFollowPolicyConfigSchema]);
...
var CollectRequestSchema = z.discriminatedUnion('type', [LegacyCollectRequestSchema, SimpleCollectRequestSchema, MultirecipientCollectRequestSchema, UnknownActionRequestSchema]);
...
var transactionKindToFilterGroup = (_transactionKindToFil = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, TransactionKind.ACT_ON_PUBLICATION, lensHubTransactionKinds), TransactionKind.BLOCK_PROFILE, lensHubTransactionKinds), TransactionKind.UNBLOCK_PROFILE, lensHubTransactionKinds), TransactionKind.CREATE_COMMENT, lensHubTransactionKinds), TransactionKind.CREATE_POST, lensHubTransactionKinds), TransactionKind.CREATE_QUOTE, lensHubTransactionKinds), TransactionKind.FOLLOW_PROFILE, lensHubTransactionKinds), TransactionKind.MIRROR_PUBLICATION, lensHubTransactionKinds), TransactionKind.UPDATE_PROFILE_MANAGERS, lensHubTransactionKinds), TransactionKind.UPDATE_FOLLOW_POLICY, lensHubTransactionKinds), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, TransactionKind.UPDATE_PROFILE_DETAILS, lensHubTransactionKinds), TransactionKind.CLAIM_HANDLE, []), TransactionKind.APPROVE_MODULE, []), TransactionKind.CREATE_PROFILE, []), TransactionKind.UNFOLLOW_PROFILE, []), TransactionKind.LINK_HANDLE, []), TransactionKind.UNLINK_HANDLE, []));
...
var SignedVote = /*#__PURE__*/_createClass(function SignedVote(pollId, signature, data, voter) {
  _classCallCheck(this, SignedVote);
  this.pollId = pollId;
  this.signature = signature;
  this.data = data;
  this.voter = voter;
...
var ConcreteWallet = /*#__PURE__*/function (_Wallet) {
  ...
  _createClass(ConcreteWallet, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 17:
              ...
              if (!(_context.t0.code === errors.ACTION_REJECTED)) {
                _context.next = 22;
                break;
              }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 16:
              ...
              if (!(_context2.t0.code === errors.ACTION_REJECTED)) {
                _context2.next = 21;
                break;
              }
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 17:
              ...
              _context3.next = _context3.t1 === errors.ACTION_REJECTED ? 23 : _context3.t1 === errors.INSUFFICIENT_FUNDS ? 24 : 25;
              break;
            case 23:
              return _context3.abrupt("return", failure(new UserRejectedError(_context3.t0.message)));
            case 24:
    ...
    key: "signVote",
    value: function () {
      var _signVote = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(unsignedVote) {
        var result, signer, _signature3, signedVote;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
            ...
            case 7:
              ...
              _context4.prev = 9;
              _context4.next = 12;
              return signer._signTypedData(unsignedVote.typedData.domain, unsignedVote.typedData.types, unsignedVote.typedData.message);
            case 12:
              _signature3 = _context4.sent;
              signedVote = new SignedVote(unsignedVote.pollId, _signature3, unsignedVote.typedData, getAddress(this.address));
              return _context4.abrupt("return", success(signedVote));
            case 17:
              _context4.prev = 17;
              _context4.t0 = _context4["catch"](9);
              assertErrorObjectWithCode(_context4.t0);
              if (!(_context4.t0.code === errors.ACTION_REJECTED)) {
                _context4.next = 22;
                break;
              }
        ...
        }, _callee4, this, [[9, 17, 23, 26]]);
      }));
      function signVote(_x4) {
        return _signVote.apply(this, arguments);
      }
      return signVote;
    }()
  }, {
...
var WalletFactory = /*#__PURE__*/function () {
  function WalletFactory(signerFactory, transactionFactory) {
    _classCallCheck(this, WalletFactory);
    this.signerFactory = signerFactory;
    this.transactionFactory = transactionFactory;
  }
  _createClass(WalletFactory, [{
    key: "create",
    value: function () {
      var _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(address) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", ConcreteWallet.create(address, this.signerFactory, this.transactionFactory));
            case 1:
            case "end":
              return _context.stop();
          }
...
var WalletStorageSchema = z.array(WalletDataSchema);
var WalletGateway = /*#__PURE__*/function () {
  function WalletGateway(storage, factory) {
  ...
  _createClass(WalletGateway, [{
    ...
    value: function () {
      var _getByAddress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(address) {
        var _wallets$find;
        var _this$inMemoryCache$a, wallets, wallet;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", (_this$inMemoryCache$a = this.inMemoryCache[address]) !== null && _this$inMemoryCache$a !== void 0 ? _this$inMemoryCache$a : never());
            case 2:
              _context.next = 4;
              return this.getAll();
            case 4:
              wallets = _context.sent;
              wallet = (_wallets$find = wallets.find(function (w) {
    ...
    key: "save",
    value: function () {
      var _save = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(wallet) {
        var wallets;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 2:
              ...
              _context3.next = 6;
              return this.storage.set(wallets.concat([wallet]).map(function (w) {
                return w.toWalletData();
              }));
            case 6:
            case "end":
              return _context3.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              return _context4.abrupt("return", []);
            case 5:
              return _context4.abrupt("return", data.map(function (d) {
                return _this.factory.rehydrate(d);
              }));
            case 6:
            case "end":
              return _context4.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 26:
              ...
              assertErrorObjectWithCode(_context.t0);
              if (!(_context.t0.code === errors.UNSUPPORTED_OPERATION)) {
                _context.next = 31;
                break;
              }
...
function createWalletStorage(storageProvider, namespace) {
  var walletStorageDataSchema = new BaseStorageSchema("lens.".concat(namespace, ".wallets"), WalletStorageSchema);
  return Storage.createForSchema(walletStorageDataSchema, storageProvider);
}

function createSharedDependencies(config) {
  var _config$logger, _config$params, _responders;
  var logger = (_config$logger = config.logger) !== null && _config$logger !== void 0 ? _config$logger : new ConsoleLogger();
  ...
  var walletStorage = createWalletStorage(config.storage, config.environment.name);
  ...
  var apolloClient = createLensApolloClient({
    queryParams: (_config$params = config.params) !== null && _config$params !== void 0 ? _config$params : defaultQueryParams,
    uri: config.environment.backend,
  ...
  var profileCacheManager = new ProfileCacheManager(apolloClient);
  var publicationCacheManager = new PublicationCacheManager(apolloClient);
  var walletFactory = new WalletFactory(signerFactory, transactionFactory);
  var walletGateway = new WalletGateway(walletStorage, walletFactory);
  var transactionGateway = new PendingTransactionGateway(transactionStorage, transactionFactory);
  var onChainRelayer = new OnChainRelayer(apolloClient, transactionFactory, logger);
  var momokaRelayer = new MomokaRelayer(apolloClient, transactionFactory, logger);
  ...
  var logout = new Logout(walletGateway, credentialsGateway, transactionGateway, conversationsGateway, logoutPresenter);
...
function useLoginController() {
  var _useSharedDependencie = useSharedDependencies(),
    ...
    walletFactory = _useSharedDependencie.walletFactory,
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            login = new Login(walletFactory, walletGateway, credentialsFactory, credentialsGateway, presenter);
            _context.next = 4;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              result = _context.sent;
              _result$data$result = result.data.result, accessToken = _result$data$result.accessToken, refreshToken = _result$data$result.refreshToken;
              return _context.abrupt("return", new Credentials(accessToken, refreshToken));
            case 5:
            case "end":
              return _context.stop();
          }
...
function useExploreProfiles() {
  ...
  return usePaginatedReadResult(useExploreProfiles$1(useLensApolloClient({
    variables: {
      limit: limit,
      where: where,
      orderBy: orderBy
...
function useExplorePublications() {
  ...
  return usePaginatedReadResult(useExplorePublications$1(useLensApolloClient({
    variables: {
      where: where,
      orderBy: orderBy
    }
...
function useFeed(_ref) {
  ...
  return usePaginatedReadResult(useFeed$1(useLensApolloClient({
    variables: {
      where: where
    }
  })));
...
function useRecommendedProfiles(args) {
  return usePaginatedReadResult(useProfileRecommendations(useLensApolloClient({
    variables: args
  })));
}
...
function useSearchProfiles(args) {
  return usePaginatedReadResult(useSearchProfiles$1(useLensApolloClient({
    variables: args
  })));
}
 ...
 * ```
 */
function useSearchPublications(args) {
  return usePaginatedReadResult(useSearchPublications$1(useLensApolloClient({
    variables: args
  })));
}
...
function useProfile(_ref) {
  ...
  var _useReadResult = useReadResult(useProfile$1(useLensApolloClient({
      variables: {
...
function useProfileFollowers(args) {
  return usePaginatedReadResult(useFollowers(useLensApolloClient({
    variables: args
  })));
}
...
function useProfileFollowing(args) {
  return usePaginatedReadResult(useFollowing(useLensApolloClient({
    variables: args
  })));
}
...
function useProfiles(args) {
  return usePaginatedReadResult(useProfiles$1(useLensApolloClient({
    variables: args
  })));
}
 ...
 */
var useMyBookmarks = useBookmarks;
...
function usePublication(_ref) {
  ...
  var _useReadResult = useReadResult(usePublication$1(useLensApolloClient({
      variables: {
 ...
 * ```
 */
function usePublications(args) {
  return usePaginatedReadResult(usePublications$1(useLensApolloClient({
    variables: args
  })));
}
...
var AbstractContractCallGateway = /*#__PURE__*/function () {
  function AbstractContractCallGateway(providerFactory) {
  ...
  _createClass(AbstractContractCallGateway, [{
    ...
    value: function () {
      var _createUnsignedTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, wallet) {
        var provider, _yield$this$createEnc, contractAddress, encodedData, gasLimit, gasEstimator, gasPriceEstimate, transactionRequest;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
            ...
            case 2:
              provider = _context.sent;
              _context.next = 5;
              return this.createEncodedData(request);
            case 5:
              _yield$this$createEnc = _context.sent;
              contractAddress = _yield$this$createEnc.contractAddress;
              encodedData = _yield$this$createEnc.encodedData;
              _context.next = 10;
            ...
            case 10:
              ...
              gasEstimator = new Eip1559GasPriceEstimator(provider, function (value) {
...
var ApproveTransactionGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(ApproveTransactionGateway, [{
    key: "createEncodedData",
    value: function () {
      var _createEncodedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      ...
      function createEncodedData(_x) {
        return _createEncodedData.apply(this, arguments);
      }
      return createEncodedData;
    }()
  }]);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            approveTransactionGateway = new ApproveTransactionGateway(providerFactory);
...
var NewProfilePresenter = /*#__PURE__*/function () {
  function NewProfilePresenter(profileCacheManager, fullHandleResolver) {
    _classCallCheck(this, NewProfilePresenter);
    _defineProperty(this, "deferredResult", new Deferred());
    _defineProperty(this, "earlyFailure", null);
    this.profileCacheManager = profileCacheManager;
    this.fullHandleResolver = fullHandleResolver;
  }
  _createClass(NewProfilePresenter, [{
    key: "present",
    value: function () {
      var _present = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(result) {
        var profile;
...
function resolveFollowModuleParams$1(policy) {
  switch (policy.type) {
...
function resolveClaimProfileWithHandleRequest(request) {
  if (isClaimReservedHandleRequest(request)) {
    return {
      id: request.id,
      followModule: request.followPolicy ? resolveFollowModuleParams$1(request.followPolicy) : null
    };
  }
  return {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new NewProfilePresenter(profileCacheManager, config.environment.handleResolver);
...
var ClaimHandleError = ClaimHandleError$1;
...
var CreateOnChainCommentGateway = /*#__PURE__*/function (_ref) {
  ...
  function CreateOnChainCommentGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
    _classCallCheck(this, CreateOnChainCommentGateway);
    _this = _super.call(this, providerFactory);
  ...
  _createClass(CreateOnChainCommentGateway, [{
    ...
    key: "createEncodedData",
    value: function () {
      var _createEncodedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(request) {
        var input, result;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
      ...
      function createEncodedData(_x4) {
        return _createEncodedData.apply(this, arguments);
      }
      return createEncodedData;
    }()
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainGateway = new CreateOnChainCommentGateway(providerFactory, apolloClient, transactionFactory);
...
var CreateOnChainMirrorGateway = /*#__PURE__*/function (_ref) {
  ...
  function CreateOnChainMirrorGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainGateway = new CreateOnChainMirrorGateway(providerFactory, apolloClient, transactionFactory);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            request = createMirrorRequest(_objectSpread2({
              signless: session.profile.signless,
              sponsored: (_args$sponsored = args.sponsored) !== null && _args$sponsored !== void 0 ? _args$sponsored : true
            }, args));
...
var CreateOnChainPostGateway = /*#__PURE__*/function (_ref) {
  ...
  function CreateOnChainPostGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainGateway = new CreateOnChainPostGateway(providerFactory, apolloClient, transactionFactory);
...
var CreateOnChainQuoteGateway = /*#__PURE__*/function (_ref) {
  ...
  function CreateOnChainQuoteGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainGateway = new CreateOnChainQuoteGateway(providerFactory, apolloClient, transactionFactory);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            request = createQuoteRequest(_objectSpread2({
              signless: session.profile.signless,
              sponsored: (_args$sponsored = args.sponsored) !== null && _args$sponsored !== void 0 ? _args$sponsored : true
            }, args));
...
var FollowProfileGateway = /*#__PURE__*/function (_ref) {
  ...
  function FollowProfileGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new TransactionResultPresenter();
            gateway = new FollowProfileGateway(providerFactory, apolloClient, transactionFactory);
...
function createFollowRequest(args, session) {
  var _args$sponsored, _args$sponsored2;
  invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            request = createFollowRequest(args, session);
...
var LinkHandleGateway = /*#__PURE__*/function (_ref) {
  ...
  function LinkHandleGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new TransactionResultPresenter();
            gateway = new LinkHandleGateway(providerFactory, apolloClient, transactionFactory);
            signedExecution = new SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", linkHandle({
...
var OpenActionGateway = /*#__PURE__*/function (_ref) {
  ...
  function OpenActionGateway(apolloClient, transactionFactory, providerFactory) {
    var _this;
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            presenter = new TransactionResultPresenter();
            onChainGateway = new OpenActionGateway(apolloClient, transactionFactory, providerFactory);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            request = resolveOpenActionRequestFor(publication, {
              action: args.action,
              signless: session.type === SessionType.WithProfile ? session.profile.signless : false,
              // cannot use Lens Manager with Public Collect
...
var ProfileMetadataGateway = /*#__PURE__*/function (_ref) {
  ...
  function ProfileMetadataGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            presenter = new TransactionResultPresenter();
            gateway = new ProfileMetadataGateway(providerFactory, apolloClient, transactionFactory);
            signedExecution = new SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", setProfileMetadata({
...
var UnfollowProfileGateway = /*#__PURE__*/function (_ref) {
  ...
  function UnfollowProfileGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new TransactionResultPresenter();
            gateway = new UnfollowProfileGateway(providerFactory, apolloClient, transactionFactory);
            signedExecution = new SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            invariant(session.type === SessionType.WithProfile, 'You must have a profile to use this operation.');
            return _context.abrupt("return", unfollowProfile({
...
var UnlinkHandleGateway = /*#__PURE__*/function (_ref) {
  ...
  function UnlinkHandleGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new TransactionResultPresenter();
            gateway = new UnlinkHandleGateway(providerFactory, apolloClient, transactionFactory);
            signedExecution = new SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", unlinkHandle({
...
function resolveFollowModuleParams(policy) {
  switch (policy.type) {
    case FollowPolicyType.CHARGE:
      return {
        feeFollowModule: {
...
var UpdateFollowPolicyGateway = /*#__PURE__*/function (_ref) {
  ...
  function UpdateFollowPolicyGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new TransactionResultPresenter();
            gateway = new UpdateFollowPolicyGateway(providerFactory, apolloClient, transactionFactory);
            signedExecution = new SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            invariant(session.type === SessionType.WithProfile, 'You must have a profile to use this operation.');
            return _context.abrupt("return", updateFollowPolicy({
...
var UpdateProfileManagersGateway = /*#__PURE__*/function (_ref) {
  ...
  function UpdateProfileManagersGateway(providerFactory, apolloClient) {
    var _this;
  ...
  _createClass(UpdateProfileManagersGateway, [{
    ...
    key: "createEncodedData",
    value: function () {
      var _createEncodedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request) {
        var result;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
      ...
      function createEncodedData(_x3) {
        return _createEncodedData.apply(this, arguments);
      }
      return createEncodedData;
    }()
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new TransactionResultPresenter();
            gateway = new UpdateProfileManagersGateway(providerFactory, apolloClient);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            return _context.abrupt("return", updateProfileManagers(_objectSpread2({
...
var UnblockProfilesGateway = /*#__PURE__*/function (_ref) {
  ...
  function UnblockProfilesGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            presenter = new TransactionResultPresenter();
            gateway = new UnblockProfilesGateway(providerFactory, apolloClient, transactionFactory);
            signedExecution = new SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", unblockProfile({
...
var BlockProfilesGateway = /*#__PURE__*/function (_ref) {
  ...
  function BlockProfilesGateway(providerFactory, apolloClient, transactionFactory) {
    var _this;
  ...
  _createClass(BlockProfilesGateway, [{
    ...
    key: "createEncodedData",
    value: function () {
      var _createEncodedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(request) {
        var result;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
      ...
      function createEncodedData(_x5) {
        return _createEncodedData.apply(this, arguments);
      }
      return createEncodedData;
    }()
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            presenter = new TransactionResultPresenter();
            gateway = new BlockProfilesGateway(providerFactory, apolloClient, transactionFactory);
            signedExecution = new SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", blockProfile({
              profileIds: profiles.map(function (profile) {
                return profile.id;
              }),
...
var development = {
  name: 'development',
  backend: 'https://api-v2-mumbai-live.lens.dev',
...
var staging = {
  name: 'staging',
  backend: 'https://api-mumbai.lens-v2.crtlkey.com',
  chains: _defineProperty(_defineProperty({}, ChainType.ETHEREUM, goerli), ChainType.POLYGON, mumbai),
  timings: {
...
export { ClaimHandleError, LensProvider, NotFoundError, PrematureFollowError, appId, development, goerli, hasReacted, mainnet, mumbai, polygon, production, profileId, publicationId, staging, useAccessToken, useApolloClient, useApproveModule, useBlockProfiles, useBlockedProfiles, useBookmarkToggle, useBookmarks, useCanClaimHandle, useClaimHandle, useCreateComment, useCreateMirror, useCreatePost, useCreateQuote, useCurrencies, useDeferredTask, useDismissRecommendedProfiles, useExploreProfiles, useExplorePublications, useFeed, useFeedHighlights, useFollow, useHidePublication, useInviteWallets, useInvitedProfiles, useLastLoggedInProfile, useLazyModuleMetadata, useLazyProfile, useLazyProfiles, useLazyPublication, useLazyPublications, useLazyWasWalletInvited, useLinkHandle, useLogin, useLogout, useModuleMetadata, useMutualFollowers, useMyBookmarks, useNotInterestedToggle, useNotifications, useOpenAction, useOwnedHandles, useProfile, useProfileActionHistory, useProfileFollowers, useProfileFollowing, useProfileManagers, useProfiles, useProfilesManaged, usePublication, usePublications, useReactionToggle, useRecommendedProfiles, useReportPublication, useResolveAddress, useRevenueFromFollow, useRevenueFromPublication, useRevenueFromPublications, useSearchProfiles, useSearchPublications, useSession, useSetProfileMetadata, useSharedDependencies, useStorage, useUnblockProfiles, useUnfollow, useUnlinkHandle, useUpdateFollowPolicy, useUpdateProfileManagers, useUpgradeCredentials, useWasWalletInvited, useWhoActedOnPublication, useWhoReactedToPublication };
