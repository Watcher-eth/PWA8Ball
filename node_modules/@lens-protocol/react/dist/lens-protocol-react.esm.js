import React, { useRef, useEffect, useContext, useState, useCallback, useMemo, useSyncExternalStore } from 'react';
import { Bootstrap, CredentialsExpiredError, LogoutReason, anonymousSessionData, SessionType, ActiveWallet, Logout, Login, UpgradeCredentials } from '@lens-protocol/domain/use-cases/authentication';
export { LogoutReason, SessionType } from '@lens-protocol/domain/use-cases/authentication';
import * as gql from '@lens-protocol/api-bindings';
import { updateSessionData, AuthChallengeDocument, AuthAuthenticateDocument, AuthRefreshDocument, RevokeAuthenticationDocument, SupportedFiatType, FragmentProfile, getSessionData, ProfileDocument, FragmentAnyPublicationInternal, isPostPublication, isCommentPublication, isMirrorPublication, isQuotePublication, PublicationDocument, LensProfileManagerRelayErrorReasonType, RelayErrorReasonType, BroadcastOnMomokaDocument, BroadcastOnchainDocument, recentTransactionsVar, TxStatus, OwnedHandlesDocument, ProfilesManagedDocument, FollowingDocument, ProfileManagersDocument, LensTransactionStatusDocument, LensTransactionStatusType, LensTransactionFailureType, createAuthApolloClient, createLensApolloClient, useSessionDataVar, sessionDataVar, useProfile as useProfile$1, UnspecifiedError, WalletAuthenticationToProfileAuthenticationDocument, DismissRecommendedProfilesDocument, ProfileRecommendationsDocument, ExploreProfilesOrderByType, ExploreProfilesDocument, ExplorePublicationsOrderByType, ExplorePublicationsDocument, FeedDocument, useFeedHighlights as useFeedHighlights$1, SearchProfilesDocument, SearchPublicationsDocument, useCurrencies as useCurrencies$1, chainType, useInvitedProfiles as useInvitedProfiles$1, InviteDocument, ProfileAlreadyInvitedDocument, InvitedProfilesDocument, useLatestPaidActions as useLatestPaidActions$1, useModuleMetadata as useModuleMetadata$1, useModuleMetadataLazyQuery, useHandleToAddressLazyQuery, omitTypename, SignFrameActionDocument, CreateFrameTypedDataDocument, useProfileAlreadyInvited, useProfileAlreadyInvitedLazyQuery, useNotifications as useNotifications$1, AddProfileInterestsDocument, RemoveProfileInterestsDocument, useWhoHaveBlocked, useProfileLazyQuery, useProfilesLazyQuery, useMutualFollowers as useMutualFollowers$1, useProfileActionHistory as useProfileActionHistory$1, FollowersDocument, useProfileManagers as useProfileManagers$1, ProfilesDocument, PeerToPeerRecommendDocument, PeerToPeerUnrecommendDocument, ReportProfileDocument, ProfileReportingReason, ProfileReportingSpamSubreason, ProfileReportingFraudSubreason, useWhoActedOnPublication as useWhoActedOnPublication$1, usePublicationBookmarks, AddPublicationBookmarkDocument, RemovePublicationBookmarkDocument, isPrimaryPublication, HideCommentDocument, UnhideCommentDocument, HidePublicationDocument, usePublicationLazyQuery, usePublicationsLazyQuery, AddPublicationNotInterestedDocument, UndoPublicationNotInterestedDocument, PublicationsDocument, AddReactionDocument, RemoveReactionDocument, PublicationReactionType, ReportPublicationDocument, PublicationReportingReason, PublicationReportingSpamSubreason, PublicationReportingSensitiveSubreason, PublicationReportingFraudSubreason, PublicationReportingIllegalSubreason, useWhoReactedPublication, useFollowRevenues, useRevenueFromPublication as useRevenueFromPublication$1, useRevenueFromPublications as useRevenueFromPublications$1, CommentOnMomokaDocument, CreateMomokaCommentTypedDataDocument, isPublicationId, CommentOnchainDocument, CreateOnchainCommentTypedDataDocument, resolveReferencePolicy, MirrorOnMomokaDocument, CreateMomokaMirrorTypedDataDocument, MirrorOnchainDocument, CreateOnchainMirrorTypedDataDocument, PostOnMomokaDocument, CreateMomokaPostTypedDataDocument, PostOnchainDocument, CreateOnchainPostTypedDataDocument, QuoteOnMomokaDocument, CreateMomokaQuoteTypedDataDocument, QuoteOnchainDocument, CreateOnchainQuoteTypedDataDocument, resolveTokenAllowanceRequest, BlockDocument, CreateBlockProfilesTypedDataDocument, ClaimProfileWithHandleDocument, resolveFollowModuleInput, GenerateLensApiRelayAddressDocument, FollowDocument, CreateFollowTypedDataDocument, TriStateValue, resolveFollowPolicy, LinkHandleToProfileDocument, CreateLinkHandleToProfileTypedDataDocument, LegacyCollectDocument, ActOnOpenActionDocument, findCollectModuleSettings, erc20Amount, SetProfileMetadataDocument, CreateOnchainSetProfileMetadataTypedDataDocument, UnblockDocument, CreateUnblockProfilesTypedDataDocument, UnfollowDocument, CreateUnfollowTypedDataDocument, UnlinkHandleFromProfileDocument, CreateUnlinkHandleFromProfileTypedDataDocument, SetFollowModuleDocument, CreateSetFollowModuleTypedDataDocument, CreateChangeProfileManagersTypedDataDocument, ChangeProfileManagerActionType, useClaimableProfiles, useLastLoggedInProfile as useLastLoggedInProfile$1, useProfilesManagedLazyQuery, useOwnedHandles as useOwnedHandles$1, useProfilesManaged as useProfilesManaged$1, useUserRateLimit } from '@lens-protocol/api-bindings';
export { ClaimProfileWithHandleErrorReasonType, CollectOpenActionModuleType, CommentRankingFilterType, ComparisonOperatorConditionType, CustomFiltersType, DecryptFailReasonType, ExploreProfilesOrderByType, ExplorePublicationType, ExplorePublicationsOrderByType, FeedEventItemType, FollowModuleType, HiddenCommentsType, LimitType, ManagedProfileVisibility, MarketplaceMetadataAttributeDisplayType, MetadataAttributeType, ModuleType, NftContractType, NotificationType, OpenActionCategoryType, OpenActionModuleType, ProfileActionHistoryType, ProfileInterestTypes, ProfilesOrderBy, PublicationContentWarningType, PublicationMetadataLicenseType, PublicationMetadataMainFocusType, PublicationMetadataTransactionType, PublicationReactionType, PublicationType, SearchPublicationType, SupportedFiatType, TriStateValue, UnspecifiedError, erc20Amount, fiatAmount, findCollectModuleSettings, isCollectModuleSettings, isCommentPublication, isMirrorPublication, isMultirecipientCollectFee, isPostPublication, isPrimaryPublication, isQuotePublication, resolveCollectPolicy, resolveFollowPolicy, resolveReferencePolicy } from '@lens-protocol/api-bindings';
import { TransactionKind, ProtocolTransactionKinds, MetaTransaction, NativeTransaction, DataTransaction, TransactionEvent, TransactionError, TransactionErrorReason, Wallet, UserRejectedError, PendingSigningRequestError, InsufficientGasError, WalletConnectionError, WalletConnectionErrorReason, ProfileReportReason, PublicationReportReason, UnsignedTransaction, isMomokaPublicationId } from '@lens-protocol/domain/entities';
export { InsufficientGasError, PendingSigningRequestError, ProfileReportReason, PublicationReportReason, TransactionError, TransactionErrorReason, UserRejectedError, WalletConnectionError, WalletConnectionErrorReason } from '@lens-protocol/domain/entities';
import { BroadcastingError, BroadcastingErrorReason, TokenAllowanceLimit, TransactionQueue, SignedOnChain, DelegableSigning, SubsidizeOffChain, PaidTransaction, TokenAllowance } from '@lens-protocol/domain/use-cases/transactions';
export { BroadcastingError, BroadcastingErrorReason, TokenAllowanceLimit } from '@lens-protocol/domain/use-cases/transactions';
import { TokenAvailability, InviteWallets, SignFrameAction } from '@lens-protocol/domain/use-cases/wallets';
export { InsufficientAllowanceError, InsufficientFundsError, WalletAlreadyInvitedError } from '@lens-protocol/domain/use-cases/wallets';
import { DateUtils, invariant, never, failure, success, InvariantError, assertError, ChainType, Kind, Amount, erc20, assertNever, BigDecimal, matic, Deferred, hasAtLeastOne, hasTwoOrMore, Denomination, CausedError, update, ether } from '@lens-protocol/shared-kernel';
export { Amount, ChainType, InvariantError, erc20, ether, fiat, matic } from '@lens-protocol/shared-kernel';
import jwtDecode from 'jwt-decode';
import isObject from 'lodash/isObject';
import { CredentialsStorageSchema, Storage, BaseStorageSchema } from '@lens-protocol/storage';
import { z } from 'zod';
import { FollowPolicyType, DismissRecommendedProfiles, ManageProfileInterests, ToggleProfileProperty, ReportProfile, BlockProfiles, isClaimReservedHandleRequest, ClaimHandleError, ClaimHandle, CreateProfile, isPaidFollowRequest, isUnknownFollowRequest, FollowProfile, LinkHandle, SetProfileMetadata, UnblockProfiles, UnfollowProfile, UnlinkHandle, UpdateFollowPolicy, UpdateProfileManagers } from '@lens-protocol/domain/use-cases/profile';
export { ClaimHandleError, FollowPolicyType } from '@lens-protocol/domain/use-cases/profile';
import { OpenActionType, ReferencePolicyType, AllOpenActionType, TogglePublicationProperty, HidePublication, ReportPublication, CreateComment, CreateMirror, CreatePost, CreateQuote, OpenAction } from '@lens-protocol/domain/use-cases/publications';
export { OpenActionType, ReferencePolicyType } from '@lens-protocol/domain/use-cases/publications';
import { erc20 as erc20$1, isTheSameAddress, isValidHandle, bigNumber, lensHub, permissionlessCreator, lensTokenHandleRegistry, publicActProxy } from '@lens-protocol/blockchain-bindings';
...
import { useLazyQuery, useSuspenseQuery, useQuery } from '@apollo/client';
import { v4 } from 'uuid';
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 14:
              ...
              _context5.next = 18;
              return (_this$logout = this.logout) === null || _this$logout === void 0 ? void 0 : _this$logout.execute(LogoutReason.CREDENTIALS_EXPIRED);
            case 18:
              return _context5.abrupt("return", failure(new CredentialsExpiredError()));
            case 19:
            case "end":
...
function createRefreshTokenStorage(storageProvider, namespace) {
  var schema = new CredentialsStorageSchema("lens.".concat(namespace, ".credentials"));
...
function createInboxKeyStorage(storageProvider, namespace) {
  var notificationStorageDataSchema = new BaseStorageSchema("lens.".concat(namespace, ".inbox.keyBundle"), KeyBundleData);
...
var ProfileCacheManager = /*#__PURE__*/function () {
  ...
  _createClass(ProfileCacheManager, [{
    ...
    key: "update",
    value: function update(profileId, updateFn) {
...
var ReferrersSchema = z.union([PublicationIdSchema, ProfileIdSchema]).array().min(1);
...
var UnknownReferencePolicyConfigSchema = z.object({
  type: z.literal(ReferencePolicyType.UNKNOWN),
  address: EvmAddressSchema,
  data: DataSchema
});
var ReferencePolicyConfigSchema = z.discriminatedUnion('type', [AnyoneReferencePolicyConfigSchema, DegreesOfSeparationReferencePolicyConfigSchema, FollowersOnlyReferencePolicyConfigSchema, NoReferencePolicyConfigSchema, UnknownReferencePolicyConfigSchema]);
...
var lensHubTransactionKinds = [TransactionKind.ACT_ON_PUBLICATION, TransactionKind.CREATE_COMMENT, TransactionKind.CREATE_POST, TransactionKind.CREATE_QUOTE, TransactionKind.FOLLOW_PROFILE, TransactionKind.MIRROR_PUBLICATION, TransactionKind.UNFOLLOW_PROFILE, TransactionKind.UPDATE_FOLLOW_POLICY, TransactionKind.UPDATE_PROFILE_DETAILS, TransactionKind.UPDATE_PROFILE_MANAGERS];
var tokenHandleRegistryTransactionKinds = [TransactionKind.LINK_HANDLE, TransactionKind.UNLINK_HANDLE];
var transactionKindToFilterGroup = (_transactionKindToFil = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, TransactionKind.ACT_ON_PUBLICATION, lensHubTransactionKinds), TransactionKind.BLOCK_PROFILE, lensHubTransactionKinds), TransactionKind.CREATE_COMMENT, lensHubTransactionKinds), TransactionKind.CREATE_POST, lensHubTransactionKinds), TransactionKind.CREATE_QUOTE, lensHubTransactionKinds), TransactionKind.FOLLOW_PROFILE, lensHubTransactionKinds), TransactionKind.MIRROR_PUBLICATION, lensHubTransactionKinds), TransactionKind.UNBLOCK_PROFILE, lensHubTransactionKinds), TransactionKind.UNFOLLOW_PROFILE, lensHubTransactionKinds), TransactionKind.UPDATE_FOLLOW_POLICY, lensHubTransactionKinds), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, TransactionKind.UPDATE_PROFILE_DETAILS, lensHubTransactionKinds), TransactionKind.UPDATE_PROFILE_MANAGERS, lensHubTransactionKinds), TransactionKind.LINK_HANDLE, tokenHandleRegistryTransactionKinds), TransactionKind.UNLINK_HANDLE, tokenHandleRegistryTransactionKinds), TransactionKind.CLAIM_HANDLE, []), TransactionKind.APPROVE_MODULE, []), TransactionKind.CREATE_PROFILE, []));
...
var CreateProfileResponder = /*#__PURE__*/function () {
  function CreateProfileResponder(apolloClient) {
    _classCallCheck(this, CreateProfileResponder);
    this.apolloClient = apolloClient;
  }
  _createClass(CreateProfileResponder, [{
    key: "commit",
    value: function () {
  ...
  return CreateProfileResponder;
}();

var FollowProfileResponder = /*#__PURE__*/function () {
  function FollowProfileResponder(apolloClient, profileCacheManager) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              request = _ref.request;
              _context.next = 3;
              return Promise.all([this.profileCacheManager.fetchProfileById(request.profileId), this.apolloClient.refetchQueries({
...
var UnfollowProfileResponder = /*#__PURE__*/function () {
  function UnfollowProfileResponder(apolloClient, profileCacheManager) {
...
var SerializableMetaTransaction = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(SerializableMetaTransaction);
...
var SerializableNativeTransaction = /*#__PURE__*/function (_ref2) {
  ...
  var _super2 = _createSuper(SerializableNativeTransaction);
...
var SerializableDataTransaction = /*#__PURE__*/function (_ref3) {
  ...
  var _super3 = _createSuper(SerializableDataTransaction);
                      ...
                      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                        while (1) switch (_context2.prev = _context2.next) {
                          ...
                          case 7:
                            ...
                            if (!(previousTxHash !== result.txHash || result.status === LensTransactionStatusType.Complete)) {
                              _context2.next = 12;
                              break;
                            }
                            subscription.unsubscribe();
...
var TransactionStorageSchema = /*#__PURE__*/function (_BaseStorageSchema) {
  ...
  var _super = _createSuper(TransactionStorageSchema);
  function TransactionStorageSchema(key) {
    var _this;
    _classCallCheck(this, TransactionStorageSchema);
    _this = _super.call(this, key, TransactionListSchema);
...
function createTransactionStorage(storageProvider, namespace) {
  var schema = new TransactionStorageSchema("lens.".concat(namespace, ".transactions"));
  return Storage.createForSchema(schema, storageProvider);
}
...
var ConcreteWallet = /*#__PURE__*/function (_Wallet) {
  ...
  var _super = _createSuper(ConcreteWallet);
  ...
  _createClass(ConcreteWallet, [{
    ...
    key: "signFrameAction",
    value: function () {
      var _signFrameAction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(unsignedAction) {
        var result, signer, _ref3, domain, types, value, _signature2;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
            ...
            case 7:
              this.signingInProgress = true;
              signer = result.value;
              _ref3 = unsignedAction.data, domain = _ref3.domain, types = _ref3.types, value = _ref3.value;
              _context2.prev = 10;
              _context2.next = 13;
        ...
        }, _callee2, this, [[10, 17, 23, 26]]);
      }));
      function signFrameAction(_x2) {
        return _signFrameAction.apply(this, arguments);
      }
      ...
      var _signMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(message) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 12:
              _signature3 = _context3.sent;
              return _context3.abrupt("return", success(_signature3));
            case 16:
              _context3.prev = 16;
    ...
    key: "sendTransaction",
    value: function () {
      var _sendTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(unsignedTransaction) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              return _context4.abrupt("return", failure(new PendingSigningRequestError()));
            case 7:
              this.signingInProgress = true;
              signer = result.value;
              _context4.prev = 9;
            ...
            case 12:
              ...
              return _context4.abrupt("return", success(transaction));
            case 17:
              _context4.prev = 17;
              _context4.t0 = _context4["catch"](9);
              assertErrorObjectWithCode(_context4.t0);
              if (!isUserRejectedError(_context4.t0)) {
                _context4.next = 22;
                break;
              }
              return _context4.abrupt("return", failure(new UserRejectedError()));
            case 22:
              if (!(_context4.t0.code === ErrorCode.INSUFFICIENT_FUNDS)) {
                _context4.next = 24;
                break;
              }
              return _context4.abrupt("return", failure(new InsufficientGasError(matic())));
            case 24:
              throw _context4.t0;
            case 25:
              _context4.prev = 25;
...
function createSharedDependencies(userConfig) {
  ...
  // storages
  var credentialsStorage = new CredentialsStorage(createRefreshTokenStorage(config.storage, config.environment.name), authApi);
  ...
  var responders = (_responders = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_responders, TransactionKind.ACT_ON_PUBLICATION, new RefreshPublicationResponder(publicationCacheManager)), TransactionKind.APPROVE_MODULE, new NoopResponder()), TransactionKind.BLOCK_PROFILE, new BlockProfilesResponder(profileCacheManager)), TransactionKind.CLAIM_HANDLE, new CreateProfileResponder(apolloClient)), TransactionKind.CREATE_COMMENT, new RefreshCurrentProfileResponder(profileCacheManager)), TransactionKind.CREATE_POST, new RefreshCurrentProfileResponder(profileCacheManager)), TransactionKind.CREATE_PROFILE, new CreateProfileResponder(apolloClient)), TransactionKind.CREATE_QUOTE, new RefreshCurrentProfileResponder(profileCacheManager)), TransactionKind.FOLLOW_PROFILE, new FollowProfileResponder(apolloClient, profileCacheManager)), TransactionKind.LINK_HANDLE, new LinkHandleResponder(apolloClient, profileCacheManager)), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_responders, TransactionKind.MIRROR_PUBLICATION, new RefreshCurrentProfileResponder(profileCacheManager)), TransactionKind.UNBLOCK_PROFILE, new UnblockProfilesResponder(profileCacheManager)), TransactionKind.UNFOLLOW_PROFILE, new UnfollowProfileResponder(apolloClient, profileCacheManager)), TransactionKind.UNLINK_HANDLE, new LinkHandleResponder(apolloClient, profileCacheManager)), TransactionKind.UPDATE_FOLLOW_POLICY, new RefreshCurrentProfileResponder(profileCacheManager)), TransactionKind.UPDATE_PROFILE_DETAILS, new RefreshCurrentProfileResponder(profileCacheManager)), TransactionKind.UPDATE_PROFILE_MANAGERS, new UpdateProfileManagersResponder(apolloClient, profileCacheManager)));
...
function useSession(args) {
  var sessionData = useSessionDataVar();
  var _useProfileFromCache = useProfileFromCache(sessionData),
    _useProfileFromCache2 = _slicedToArray(_useProfileFromCache, 2),
    primeCacheWithProfile = _useProfileFromCache2[0],
    data = _useProfileFromCache2[1];
  var result = resultFrom(sessionData, data);
  var update = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(newSessionData) {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return primeCacheWithProfile(newSessionData.profileId);
          case 4:
  ...
  useEffect(function () {
    if (result.loading) {
      if ((sessionData === null || sessionData === void 0 ? void 0 : sessionData.type) === SessionType.WithProfile) {
        void update(sessionData);
        return;
      }
      return sessionDataVar.onNextChange( /*#__PURE__*/function () {
        var _onNext = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(newSessionData) {
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return update(newSessionData);
              case 2:
              case "end":
                return _context2.stop();
            }
  ...
  // Handle suspense
  if (args !== null && args !== void 0 && args.suspense) {
    if (result.loading) {
      // Do the same thing as the effect right above because the effect won't run
      // when we suspend.

      throw new Promise(function (resolve) {
        sessionDataVar.onNextChange( /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(newSessionData) {
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
...
function useProfileFromCache(data) {
  var fill = useLazyFragmentVariables();
  var shouldFetchProfile = (data === null || data === void 0 ? void 0 : data.type) === SessionType.WithProfile;
  var profileId = (data === null || data === void 0 ? void 0 : data.type) === SessionType.WithProfile ? data.profileId : undefined;
  var _useProfile = useProfile$1(useLensApolloClient({
    ...
    _useProfile$data = _useProfile.data,
    _useProfile$data2 = _useProfile$data === void 0 ? {
      result: null
    } : _useProfile$data,
    profile = _useProfile$data2.result,
    _useProfile$previousD = _useProfile.previousData,
    _useProfile$previousD2 = _useProfile$previousD === void 0 ? {
      result: null
    } : _useProfile$previousD,
    previousProfile = _useProfile$previousD2.result,
    error = _useProfile.error,
    refetch = _useProfile.refetch;
  var primeCacheWithProfile = function primeCacheWithProfile(id) {
    return refetch(fill({
      request: {
        forProfileId: id
      }
  ...
  return [primeCacheWithProfile, {
    error: error,
    profile: profile,
    previousProfile: previousProfile
  }];
}
function resultFrom(sessionData, _ref3) {
  var _ref4;
  var error = _ref3.error,
    profile = _ref3.profile,
    previousProfile = _ref3.previousProfile;
  if (!sessionData || sessionData.type === SessionType.WithProfile && !profile && !previousProfile) {
    return {
      data: undefined,
      error: undefined,
      loading: true
    ...
    case SessionType.WithProfile:
      return {
        data: {
          ...
          authenticated: true,
          address: sessionData.address,
          profile: (_ref4 = profile !== null && profile !== void 0 ? profile : previousProfile) !== null && _ref4 !== void 0 ? _ref4 : never('This should never happen.')
        },
        error: undefined,
        loading: false
      };
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              result = _context.sent;
              _result$data$result = result.data.result, accessToken = _result$data$result.accessToken, identityToken = _result$data$result.identityToken, refreshToken = _result$data$result.refreshToken;
              return _context.abrupt("return", new JwtCredentials(accessToken, identityToken, refreshToken));
            case 5:
            case "end":
              return _context.stop();
          }
 ...
 * @internal
 */
function usePaginatedReadResult(_ref2) {
  ...
  var probeForNewerResults = useCallback( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(prev) {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
  ...
  return _objectSpread2(_objectSpread2({}, buildReadResult(data === null || data === void 0 ? void 0 : data.result.items, error)), {}, {
    ...
    prev: function () {
      var _prev = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              if (!loading) {
...
function useSuspenseResult(_ref) {
  var data = _ref.data,
    error = _ref.error;
  if (error) {
    throw error;
 ...
 * @internal
 */
function useSuspendableQuery(args) {
  if (args.suspense) {
    return useSuspenseResult(useSuspenseQuery(args.query, args.options));
  }
  return useReadResult(useQuery(args.query, args.options));
}
...
function useSuspensePaginatedResult(_ref2) {
  var data = _ref2.data,
    error = _ref2.error,
    fetchMore = _ref2.fetchMore;
  if (error) {
  ...
  return {
    ...
    prev: function () {
      var _prev = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
 ...
 * @internal
 */
function useSuspendablePaginatedQuery(args) {
  if (args.suspense) {
    return useSuspensePaginatedResult(useSuspenseQuery(args.query, args.options));
  }
  return usePaginatedReadResult(useQuery(args.query, args.options));
}
...
function useFeed(_ref) {
  var _where$metadata;
  var _ref$suspense = _ref.suspense,
    suspense = _ref$suspense === void 0 ? false : _ref$suspense,
    where = _ref.where;
  var _useSession = useSession({
      suspense: suspense
...
function useFeedHighlights(_ref) {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(useFeedHighlights$1(useLensApolloClient({
    variables: useFragmentVariables({
      where: where,
      statsFor: where === null || where === void 0 || (_where$metadata = where.metadata) === null || _where$metadata === void 0 ? void 0 : _where$metadata.publishedOn
    }),
...
function useRecommendedProfiles(_ref) {
  var _ref$suspense = _ref.suspense,
    suspense = _ref$suspense === void 0 ? false : _ref$suspense,
...
function useSearchProfiles(_ref) {
  var _ref$suspense = _ref.suspense,
    suspense = _ref$suspense === void 0 ? false : _ref$suspense,
...
var ExternalStorageAdapter = /*#__PURE__*/_createClass(function ExternalStorageAdapter(credentialsStorage) {
  var _this = this;
  _classCallCheck(this, ExternalStorageAdapter);
  _defineProperty(this, "cache", null);
  _defineProperty(this, "subscribe", function (cb) {
    // initial value
    void _this.credentialsStorage.get().then(function (credentials) {
      _this.cache = credentials;
      cb();
    });

    // subsequent values
    var subscription = _this.credentialsStorage.subscribe(function (credentials) {
      _this.cache = credentials;
      cb();
    });
    return function () {
...
function useCredentials() {
  var _useSharedDependencie = useSharedDependencies(),
    credentialsStorage = _useSharedDependencie.credentialsStorage;
  var adapter = useMemo(function () {
    return new ExternalStorageAdapter(credentialsStorage);
  }, [credentialsStorage]);
  var credentials = useSyncExternalStore(adapter.subscribe, adapter.get);
  return credentials;
}
...
function useAccessToken() {
  var _credentials$accessTo;
  var credentials = useCredentials();
  return (_credentials$accessTo = credentials === null || credentials === void 0 ? void 0 : credentials.accessToken) !== null && _credentials$accessTo !== void 0 ? _credentials$accessTo : null;
}
...
function useIdentityToken() {
  var _credentials$identity;
  var credentials = useCredentials();
  return (_credentials$identity = credentials === null || credentials === void 0 ? void 0 : credentials.identityToken) !== null && _credentials$identity !== void 0 ? _credentials$identity : null;
}
...
function useRefreshToken() {
  var _credentials$refreshT;
  var credentials = useCredentials();
  return (_credentials$refreshT = credentials === null || credentials === void 0 ? void 0 : credentials.refreshToken) !== null && _credentials$refreshT !== void 0 ? _credentials$refreshT : null;
}
...
function useCurrencies() {
  var _result$data;
  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var result = usePaginatedReadResult(useCurrencies$1(useLensApolloClient({
    variables: args
  })));
  if (result.loading) {
    return result;
...
function useInvitedProfiles() {
  ...
  return useReadResult(useInvitedProfiles$1(useLensApolloClient({
    variables: useFragmentVariables()
  })));
}
 ...
 */
function useLatestPaidActions() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    filter = _ref.filter,
    where = _ref.where;
  return usePaginatedReadResult(useLatestPaidActions$1(useLensApolloClient({
    variables: useFragmentVariables({
      filter: filter,
      where: where
    })
...
function useModuleMetadata(args) {
  return useReadResult(useModuleMetadata$1(useLensApolloClient({
    variables: {
      request: args
    }
  })));
...
function useLazyModuleMetadata() {
  var _useModuleMetadataLaz = useModuleMetadataLazyQuery(useLensApolloClient({
...
function useResolveAddress() {
  var _useHandleToAddressLa = useHandleToAddressLazyQuery(useLensApolloClient()),
...
var _excluded$5 = ["deadline"];
var SignFrameActionGateway = /*#__PURE__*/function () {
  function SignFrameActionGateway(apolloClient) {
    _classCallCheck(this, SignFrameActionGateway);
    this.apolloClient = apolloClient;
  }
  _createClass(SignFrameActionGateway, [{
    key: "signFrameAction",
    value: function () {
      var _signFrameAction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        var requestWithoutDeadline, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              // omit deadline from request
              request.deadline, requestWithoutDeadline = _objectWithoutProperties(request, _excluded$5);
              _context.next = 3;
              return this.apolloClient.mutate({
            ...
            case 3:
              result = _context.sent;
              return _context.abrupt("return", omitTypename(result.data.result));
            case 5:
            case "end":
              return _context.stop();
          }
      ...
      function signFrameAction(_x) {
        return _signFrameAction.apply(this, arguments);
      }
      return signFrameAction;
    }()
  }, {
    key: "createUnsignedFrameAction",
    value: function () {
      var _createUnsignedFrameAction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request) {
        var result;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
      ...
      function createUnsignedFrameAction(_x2) {
        return _createUnsignedFrameAction.apply(this, arguments);
      }
      return createUnsignedFrameAction;
    }()
  }]);
  return SignFrameActionGateway;
}();

function useSignFrameActionController() {
  var _useSharedDependencie = useSharedDependencies(),
    activeWallet = _useSharedDependencie.activeWallet,
    apolloClient = _useSharedDependencie.apolloClient;
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      var presenter, gateway, frameAction;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            presenter = new PromiseResultPresenter();
            gateway = new SignFrameActionGateway(apolloClient);
            frameAction = new SignFrameAction(activeWallet, gateway, presenter);
            _context.next = 5;
            return frameAction.execute(request);
          case 5:
            return _context.abrupt("return", presenter.asResult());
          case 6:
          case "end":
...
var DEFAULT_DEADLINE = 30 * 60 * 1000; // 30 minutes
 ...
 * @group Hooks
 */
function useSignFrameAction() {
  var _useSession = useSession(),
    session = _useSession.data;
  var sign = useSignFrameActionController();
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      var result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant((session === null || session === void 0 ? void 0 : session.type) === SessionType.WithProfile, 'You must be authenticated with a profile. Use `useLogin` hook to authenticate.');
            _context.next = 3;
            return sign({
              input: _objectSpread2(_objectSpread2({}, args), {}, {
          ...
          case 3:
            ...
            return _context.abrupt("return", result);
          case 6:
            return _context.abrupt("return", success(result.value));
          case 7:
          case "end":
            return _context.stop();
        }
...
var HandleNotAvailableError = /*#__PURE__*/function (_Error) {
  ...
  var _super = _createSuper(HandleNotAvailableError);
  function HandleNotAvailableError(handle) {
    var _this;
    _classCallCheck(this, HandleNotAvailableError);
    _this = _super.call(this, "Handle \"".concat(handle, "\" is already taken"));
...
var InvalidHandleError = /*#__PURE__*/function (_Error2) {
  ...
  var _super2 = _createSuper(InvalidHandleError);
  function InvalidHandleError(localName) {
    var _this2;
    _classCallCheck(this, InvalidHandleError);
    _this2 = _super2.call(this, "Handle \"".concat(localName, "\" is not valid"));
...
function useWasWalletInvited(args) {
  return useReadResult(useProfileAlreadyInvited(useLensApolloClient({
    variables: {
      request: args
    }
  })));
...
function useLazyWasWalletInvited() {
  var _useProfileAlreadyInv = useProfileAlreadyInvitedLazyQuery(useLensApolloClient()),
...
function useNotifications() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    where = _ref.where;
  return usePaginatedReadResult(useNotifications$1(useLensApolloClient({
    variables: useFragmentVariables({
      where: where,
...
var ProfileInterestsGateway = /*#__PURE__*/function () {
  function ProfileInterestsGateway(apolloClient) {
    _classCallCheck(this, ProfileInterestsGateway);
    this.apolloClient = apolloClient;
  }
  _createClass(ProfileInterestsGateway, [{
    key: "add",
    value: function () {
  ...
  return ProfileInterestsGateway;
}();

var ProfileInterestsPresenter = /*#__PURE__*/function () {
  function ProfileInterestsPresenter(profileCacheManager, profileId) {
    _classCallCheck(this, ProfileInterestsPresenter);
    this.profileCacheManager = profileCacheManager;
    this.profileId = profileId;
  }
  _createClass(ProfileInterestsPresenter, [{
    key: "add",
    value: function () {
      var _add = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              this.profileCacheManager.update(this.profileId, function (current) {
                return _objectSpread2(_objectSpread2({}, current), {}, {
                  interests: [].concat(_toConsumableArray(current.interests), _toConsumableArray(request.interests))
                });
              });
            case 1:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              this.profileCacheManager.update(this.profileId, function (current) {
                return _objectSpread2(_objectSpread2({}, current), {}, {
                  interests: current.interests.filter(function (interest) {
                    return !request.interests.includes(interest);
                  })
                });
              });
            case 1:
...
function useProfileInterestsController() {
  var _useSharedDependencie = useSharedDependencies(),
    apolloClient = _useSharedDependencie.apolloClient,
    profileCacheManager = _useSharedDependencie.profileCacheManager;
  var _useSession = useSession(),
  ...
  var add = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      var presenter, gateway, manageInterests;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant((session === null || session === void 0 ? void 0 : session.type) === SessionType.WithProfile, 'You must be authenticated with a profile to use this hook. Use `useLogin` hook to authenticate.');
            presenter = new ProfileInterestsPresenter(profileCacheManager, session.profile.id);
            gateway = new ProfileInterestsGateway(apolloClient);
            manageInterests = new ManageProfileInterests(gateway, presenter);
            _context.next = 6;
            return manageInterests.add(request);
          case 6:
          case "end":
            return _context.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            manageInterests = new ManageProfileInterests(gateway, presenter);
            _context2.next = 6;
            return manageInterests.remove(request);
          case 6:
          case "end":
            return _context2.stop();
        }
 ...
 * @group Hooks
 */
function useAddProfileInterests() {
  var _useProfileInterestsC = useProfileInterestsController(),
    add = _useProfileInterestsC.add;
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
...
function useBlockedProfiles() {
  ...
  return usePaginatedReadResult(useWhoHaveBlocked(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useLazyProfile() {
  var _useProfileLazyQuery = useProfileLazyQuery(useLensApolloClient({
      fetchPolicy: 'cache-and-network'
    })),
...
function useLazyProfiles() {
  var _useProfilesLazyQuery = useProfilesLazyQuery(useLensApolloClient({
      fetchPolicy: 'no-cache'
    })),
...
function useMutualFollowers(args) {
  return usePaginatedReadResult(useMutualFollowers$1(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}

var _excluded$4 = ["suspense"];
function profileNotFound(_ref) {
  var forProfileId = _ref.forProfileId,
    forHandle = _ref.forHandle;
  return new NotFoundError(forProfileId ? "Profile with id: ".concat(forProfileId) : "Profile with handle: ".concat(forHandle ? forHandle : ''));
}
...
function useProfile(_ref2) {
  var _ref2$suspense = _ref2.suspense,
    suspense = _ref2$suspense === void 0 ? false : _ref2$suspense,
    request = _objectWithoutProperties(_ref2, _excluded$4);
  invariant(request.forProfileId === undefined || request.forHandle === undefined, "Only one of 'forProfileId' or 'forHandle' should be provided to 'useProfile' hook");
  var result = useSuspendableQuery({
    suspense: suspense,
    query: ProfileDocument,
    options: useLensApolloClient({
      variables: useFragmentVariables({
...
function useProfileActionHistory() {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(useProfileActionHistory$1(useLensApolloClient({
    variables: args,
    skip: (session === null || session === void 0 ? void 0 : session.type) !== SessionType.WithProfile
  })));
}

var _excluded$3 = ["suspense"];
...
function useProfileFollowers(_ref) {
  var _ref$suspense = _ref.suspense,
    suspense = _ref$suspense === void 0 ? false : _ref$suspense,
...
function useProfileFollowing(_ref) {
  var _ref$suspense = _ref.suspense,
    suspense = _ref$suspense === void 0 ? false : _ref$suspense,
...
function useProfileManagers(args) {
  return usePaginatedReadResult(useProfileManagers$1(useLensApolloClient({
    variables: {
      request: args
    }
  })));
...
var RecommendProfileGateway = /*#__PURE__*/function () {
  function RecommendProfileGateway(apolloClient) {
    _classCallCheck(this, RecommendProfileGateway);
    this.apolloClient = apolloClient;
  }

  // recommend
  _createClass(RecommendProfileGateway, [{
    key: "on",
    value: function () {
      var _on = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
        var id;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "off",
    value: function () {
      var _off = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref2) {
        var id;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
  ...
  return RecommendProfileGateway;
}();

var RecommendProfilePresenter = /*#__PURE__*/function () {
  function RecommendProfilePresenter(profileCacheManager) {
    _classCallCheck(this, RecommendProfilePresenter);
    this.profileCacheManager = profileCacheManager;
  }

  // recommend
  _createClass(RecommendProfilePresenter, [{
    key: "on",
    value: function () {
      var _on = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
        var id;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              id = _ref.id;
              this.profileCacheManager.update(id, function (current) {
                return _objectSpread2(_objectSpread2({}, current), {}, {
  ...
  return RecommendProfilePresenter;
}();

function useRecommendProfileController() {
  var _useSharedDependencie = useSharedDependencies(),
    apolloClient = _useSharedDependencie.apolloClient,
    profileCacheManager = _useSharedDependencie.profileCacheManager;
  var recommend = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      var presenter, gateway, toggle;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            presenter = new RecommendProfilePresenter(profileCacheManager);
            gateway = new RecommendProfileGateway(apolloClient);
            toggle = new ToggleProfileProperty(gateway, presenter);
            _context.next = 5;
            return toggle.on(request);
          case 5:
          case "end":
            return _context.stop();
        }
    ...
    return function recommend(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  var unrecommend = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request) {
      var presenter, gateway, toggle;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
    ...
    return function unrecommend(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();
  return {
...
function useRecommendProfileToggle() {
  var _useSession = useSession(),
    session = _useSession.data;
  var _useRecommendProfileC = useRecommendProfileController(),
    recommend = _useRecommendProfileC.recommend,
    unrecommend = _useRecommendProfileC.unrecommend;
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      var profile;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
 ...
 * @group Hooks
 */
function useRemoveProfileInterests() {
  var _useProfileInterestsC = useProfileInterestsController(),
    remove = _useProfileInterestsC.remove;
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
...
function useWhoActedOnPublication(args) {
  return usePaginatedReadResult(useWhoActedOnPublication$1(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useBookmarks() {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(usePublicationBookmarks(useLensApolloClient({
    variables: useFragmentVariables({
      request: args,
      ...
      var _on = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              id = _ref.id;
              this.publicationCacheManager.update(id, function (current) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            toggle = new TogglePublicationProperty(gateway, presenter);
            _context.next = 5;
            return toggle.on(request);
          case 5:
          case "end":
...
function useLazyPublication() {
  var _usePublicationLazyQu = usePublicationLazyQuery(useLensApolloClient({
      fetchPolicy: 'cache-and-network'
    })),
...
function useLazyPublications() {
  var _usePublicationsLazyQ = usePublicationsLazyQuery(useLensApolloClient({
      fetchPolicy: 'no-cache'
    })),
...
function useNotInterestedToggle() {
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      var publication, _ref3, id, isNotInterested;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            publication = _ref.publication;
            invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            _ref3 = isMirrorPublication(publication) ? publication.mirrorOn : publication, id = _ref3.id, isNotInterested = _ref3.operations.isNotInterested;
            if (!isNotInterested) {
              _context.next = 8;
              break;
            }
...
var _excluded = ["suspense"];
function publicationNotFound(_ref) {
  var forId = _ref.forId,
    forTxHash = _ref.forTxHash;
  return new NotFoundError(forId ? "Publication with id ".concat(forId, " was not found") : "Publication with txHash ".concat(forTxHash ? forTxHash : '', " was not found"));
}
...
function usePublication(_ref2) {
  var _ref2$suspense = _ref2.suspense,
    suspense = _ref2$suspense === void 0 ? false : _ref2$suspense,
    request = _objectWithoutProperties(_ref2, _excluded);
  invariant(request.forId === undefined || request.forTxHash === undefined, "Only one of 'forId' or 'forTxHash' should be provided to 'usePublication' hook");
  var result = useSuspendableQuery({
    suspense: suspense,
    query: PublicationDocument,
    options: useLensApolloClient({
    ...
    value: function () {
      var _on = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              this.publicationCacheManager.update(request.id, function (current) {
                if (isPrimaryPublication(current)) {
                  return _objectSpread2(_objectSpread2({}, current), {}, {
...
function useWhoReactedToPublication(args) {
  return usePaginatedReadResult(useWhoReactedPublication(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useRevenueFromFollow(args) {
  var _useReadResult = useReadResult(useFollowRevenues(useLensApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
function useRevenueFromPublication(args) {
  var _useReadResult = useReadResult(useRevenueFromPublication$1(useLensApolloClient({
      variables: useFragmentVariables({
        request: args,
...
function useRevenueFromPublications(args) {
  return usePaginatedReadResult(useRevenueFromPublications$1(useLensApolloClient({
...
function resolveOnchainReferrers(referrers) {
...
var CreateOnChainCommentGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(CreateOnChainCommentGateway);
  function CreateOnChainCommentGateway(config, providerFactory, apolloClient, transactionFactory) {
    ...
    _this = _super.call(this, config, providerFactory);
  ...
  _createClass(CreateOnChainCommentGateway, [{
    ...
    value: function createCommentCallDetails(result) {
      var contract = lensHub(result.typedData.domain.verifyingContract);
...
function extractUnknownOpenActionModuleAddresses() {
  ...
  return actions.reduce(function (addresses, action) {
...
function extractUnknownReferenceModuleAddress(reference) {
  if (!reference) {
    return [];
  }
...
function extractUnknownModuleConfigAddresses(_ref) {
  var _ref$actions = _ref.actions,
    actions = _ref$actions === void 0 ? [] : _ref$actions,
    reference = _ref.reference;
  return [].concat(_toConsumableArray(extractUnknownOpenActionModuleAddresses(actions)), _toConsumableArray(extractUnknownReferenceModuleAddress(reference)));
}

function useExecutionMode() {
  var _useSharedDependencie = useSharedDependencies(),
    config = _useSharedDependencie.config;
  var _useLazyPublication = useLazyPublication(),
    fetchPublication = _useLazyPublication.execute;
  var _useLazyModuleMetadat = useLazyModuleMetadata(),
    fetchModuleMetadata = _useLazyModuleMetadat.execute;
  return /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      var actions, author, reference, referencedPublicationId, sponsored, result, publication, referencePolicy, unknownModules, results, desired, _iterator, _step, _result, sponsoredApproved;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            actions = _ref.actions, author = _ref.author, reference = _ref.reference, referencedPublicationId = _ref.referencedPublicationId, sponsored = _ref.sponsored;
            if (!(sponsored === false)) {
              _context.next = 3;
              break;
            }
          ...
          case 7:
            ...
            return fetchPublication({
              forId: referencedPublicationId
            });
          case 10:
            result = _context.sent;
            publication = result.unwrap();
            invariant(isPrimaryPublication(publication), "Referenced publication ".concat(referencedPublicationId, " is not a primary publication: ").concat(publication.__typename));
            referencePolicy = resolveReferencePolicy(publication);
          ...
          case 17:
            unknownModules = extractUnknownModuleConfigAddresses({
              actions: actions,
              reference: reference
            });
            _context.next = 20;
            return Promise.all(unknownModules.map(function (implementation) {
              return fetchModuleMetadata({
                implementation: implementation
              });
            }));
          case 20:
            results = _context.sent;
            desired = author.sponsor ? {
              signless: author.signless,
              sponsored: true
            } : {
              signless: false,
          ...
          case 25:
            ...
            if (!(_result.error instanceof NotFoundError)) {
              _context.next = 30;
              break;
            }
          ...
          case 30:
            throw _result.error;
          case 31:
            sponsoredApproved = _result.value.sponsoredApproved; // ignore signlessApproved for now
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant((session === null || session === void 0 ? void 0 : session.type) === SessionType.WithProfile, 'You must be authenticated with a Profile to comment. Use `useLogin` hook to authenticate.');
            _context.next = 3;
          ...
          case 3:
            mode = _context.sent;
            request = createCommentRequest(_objectSpread2(_objectSpread2({}, args), mode));
...
var CreateOnChainMirrorGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(CreateOnChainMirrorGateway);
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant((session === null || session === void 0 ? void 0 : session.type) === SessionType.WithProfile, 'You must be authenticated with a Profile to mirror. Use `useLogin` hook to authenticate.');
            _context.next = 3;
            return resolveExecutionMode({
              author: session.profile,
          ...
          case 3:
            mode = _context.sent;
            request = createMirrorRequest(_objectSpread2(_objectSpread2({}, args), mode));
...
var CreateOnChainPostGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(CreateOnChainPostGateway);
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            mode = _context.sent;
            request = createPostRequest(_objectSpread2(_objectSpread2({}, args), mode));
...
var CreateOnChainQuoteGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(CreateOnChainQuoteGateway);
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            invariant((session === null || session === void 0 ? void 0 : session.type) === SessionType.WithProfile, 'You must be authenticated with a Profile to quote. Use `useLogin` hook to authenticate.');
            _context.next = 3;
            return resolveExecutionMode({
              actions: args.actions,
              author: session.profile,
          ...
          case 3:
            mode = _context.sent;
            request = createQuoteRequest(_objectSpread2(_objectSpread2({}, args), mode));
 ...
 * @experimental
 */
var UploadError = /*#__PURE__*/function (_CausedError) {
  _inherits(UploadError, _CausedError);
  ...
  function UploadError(message) {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", 'UploadError');
    return _this;
  }
 ...
 */
var BaseUploader = /*#__PURE__*/function () {
  function BaseUploader(handler) {
  ...
  _createClass(BaseUploader, [{
    ...
    key: "addFile",
    value: (function () {
      var _addFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(file) {
        var location;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 3:
              ...
              return _context2.abrupt("return", uri(location));
            case 5:
    ...
    key: "addURI",
    value: (function () {
      var _addURI = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, value) {
        var response, blob, _file;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 3:
              ...
              throw new UploadError("Cannot read file from ".concat(value));
            case 6:
              _context3.next = 8;
              return response.blob();
            case 8:
              blob = _context3.sent;
              _file = new File([blob], name);
              return _context3.abrupt("return", this.addFile(_file));
            case 11:
              return _context3.abrupt("return", uri(value));
            case 12:
            case "end":
              return _context3.stop();
          }
      ...
      function addURI(_x2, _x3) {
        return _addURI.apply(this, arguments);
      }
      return addURI;
    }()
    /**
    ...
    key: "finalize",
    value: (function () {
      var _finalize = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
            case "end":
...
var _LinkedResourcesPaths;

// Adapted from ts-toolbelt: https://github.com/millsp/ts-toolbelt/blob/master/sources/Object/Paths.ts#L21

var LinkedResourcesPaths = (_LinkedResourcesPaths = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_LinkedResourcesPaths, PublicationSchemaId.ARTICLE_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.AUDIO_LATEST, ['lens.audio.item', 'lens.audio.cover', 'lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.CHECKING_IN_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.EMBED_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.EVENT_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.IMAGE_LATEST, ['lens.image.item', 'lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.LINK_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.LIVESTREAM_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.MINT_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.SPACE_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_LinkedResourcesPaths, PublicationSchemaId.STORY_LATEST, ['lens.asset.item', 'lens.asset.cover']), PublicationSchemaId.TEXT_ONLY_LATEST, []), PublicationSchemaId.THREE_D_LATEST, ['lens.assets[n].uri', 'lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.TRANSACTION_LATEST, ['lens.attachments[n].item', 'lens.attachments[n].cover']), PublicationSchemaId.VIDEO_LATEST, ['lens.video.item', 'lens.video.cover', 'lens.attachments[n].item', 'lens.attachments[n].cover']));
function resolveResourcePaths(_ref) {
...
var PublicationMetadataUploader = /*#__PURE__*/function () {
  function PublicationMetadataUploader(uploader) {
    _classCallCheck(this, PublicationMetadataUploader);
    this.uploader = uploader;
  }
  _createClass(PublicationMetadataUploader, [{
    key: "upload",
    value: function () {
      var _upload = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(metadata) {
        var file, uri;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return this.uploader.initialize();
            case 3:
              _context.next = 5;
              return this.prepare(metadata);
            case 5:
              file = _context.sent;
              _context.next = 8;
            ...
            case 8:
              uri = _context.sent;
              _context.next = 11;
              return this.uploader.finalize();
            case 11:
              return _context.abrupt("return", success(uri));
            case 14:
              _context.prev = 14;
              _context.t0 = _context["catch"](0);
              assertError(_context.t0);
              if (!(_context.t0 instanceof UploadError)) {
                _context.next = 19;
                break;
              }
              return _context.abrupt("return", failure(_context.t0));
            case 19:
              return _context.abrupt("return", failure(new UploadError('Failed to upload metadata', {
                cause: _context.t0
              })));
            case 20:
            case "end":
    ...
    key: "prepare",
    value: function () {
      var _prepare = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(metadata) {
        var _this = this;
        var paths, updated, blob;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              paths = resolveResourcePaths(metadata);
              _context3.next = 3;
              return update(metadata, paths, /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(uri, path) {
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      case 0:
                        return _context2.abrupt("return", _this.uploader.addURI(path, uri));
                      case 1:
                      case "end":
                        return _context2.stop();
                    }
            ...
            case 3:
              ...
              blob = new Blob([JSON.stringify(updated)], {
                type: 'application/json'
              });
              return _context3.abrupt("return", new File([blob], 'metadata.json'));
            case 6:
            case "end":
              return _context3.stop();
          }
  ...
  return PublicationMetadataUploader;
}();

function metadataCommon(lens) {
  var _lens$appId, _lens$attributes$map, _lens$attributes;
  return {
    appId: (_lens$appId = lens.appId) !== null && _lens$appId !== void 0 ? _lens$appId : null,
    attributes: (_lens$attributes$map = (_lens$attributes = lens.attributes) === null || _lens$attributes === void 0 ? void 0 : _lens$attributes.map(metadataAttribute)) !== null && _lens$attributes$map !== void 0 ? _lens$attributes$map : null,
    contentWarning: null,
    encryptedWith: null,
    hideFromFeed: false,
    id: lens.id,
...
function encryptableImageSet(uri) {
  return {
...
function publicationMetadataMediaImage(image) {
  var _image$altTag, _image$attributes$map, _image$attributes;
  return {
    __typename: 'PublicationMetadataMediaImage',
    image: encryptableImageSet(image.item),
    altTag: (_image$altTag = image.altTag) !== null && _image$altTag !== void 0 ? _image$altTag : null,
    attributes: (_image$attributes$map = (_image$attributes = image.attributes) === null || _image$attributes === void 0 ? void 0 : _image$attributes.map(metadataAttribute)) !== null && _image$attributes$map !== void 0 ? _image$attributes$map : null,
    license: image.license ? publicationMetadataLicenseType(image.license) : null
  };
}
function metadataAttribute(attribute) {
  return {
    type: attribute.type,
    key: attribute.key,
...
function publicationMetadataMediaVideo(video) {
  var _video$altTag, _video$attributes$map, _video$attributes, _video$duration;
  return {
    ...
    altTag: (_video$altTag = video.altTag) !== null && _video$altTag !== void 0 ? _video$altTag : null,
    attributes: (_video$attributes$map = (_video$attributes = video.attributes) === null || _video$attributes === void 0 ? void 0 : _video$attributes.map(metadataAttribute)) !== null && _video$attributes$map !== void 0 ? _video$attributes$map : null,
    cover: video.cover ? encryptableImageSet(video.cover) : null,
    duration: (_video$duration = video.duration) !== null && _video$duration !== void 0 ? _video$duration : null,
    license: video.license ? publicationMetadataLicenseType(video.license) : null
  };
}
function publicationMetadataMediaAudio(audio) {
  var _audio$attributes$map, _audio$attributes, _audio$artist, _audio$credits, _audio$duration, _audio$genre, _audio$lyrics, _audio$recordLabel;
  return {
    ...
    attributes: (_audio$attributes$map = (_audio$attributes = audio.attributes) === null || _audio$attributes === void 0 ? void 0 : _audio$attributes.map(metadataAttribute)) !== null && _audio$attributes$map !== void 0 ? _audio$attributes$map : null,
    license: audio.license ? publicationMetadataLicenseType(audio.license) : null,
    artist: (_audio$artist = audio.artist) !== null && _audio$artist !== void 0 ? _audio$artist : null,
    cover: audio.cover ? encryptableImageSet(audio.cover) : null,
    credits: (_audio$credits = audio.credits) !== null && _audio$credits !== void 0 ? _audio$credits : null,
    duration: (_audio$duration = audio.duration) !== null && _audio$duration !== void 0 ? _audio$duration : null,
    genre: (_audio$genre = audio.genre) !== null && _audio$genre !== void 0 ? _audio$genre : null,
    lyrics: (_audio$lyrics = audio.lyrics) !== null && _audio$lyrics !== void 0 ? _audio$lyrics : null,
    recordLabel: (_audio$recordLabel = audio.recordLabel) !== null && _audio$recordLabel !== void 0 ? _audio$recordLabel : null
  };
}
function publicationMetadataMedia(media) {
  switch (true) {
    case media.type in metadata.MediaAudioMimeType:
      return publicationMetadataMediaAudio(media);
    case media.type in metadata.MediaImageMimeType:
      return publicationMetadataMediaImage(media);
    case media.type in metadata.MediaVideoMimeType:
      return publicationMetadataMediaVideo(media);
  }
  never(media.type);
}
function publicationMetadataTransactionType(type) {
  switch (type) {
...
function publicationMetadataLicenseType(license) {
  if (license in metadata.MetadataLicenseType) {
    return license;
  }
  return null;
}
function publicationMetadata(_ref) {
  var _lens$title, _lens$attachments$map, _lens$attachments, _lens$content, _lens$attachments$map2, _lens$attachments2, _lens$title2, _lens$content2, _lens$attachments$map3, _lens$attachments3, _lens$title3, _lens$content3, _lens$title4, _lens$attachments$map4, _lens$attachments4, _lens$content4, _lens$attachments$map5, _lens$attachments5, _lens$content5, _lens$attachments$map6, _lens$attachments6, _lens$content6, _lens$attachments$map7, _lens$attachments7, _lens$content7, _lens$attachments$map8, _lens$attachments8, _lens$content8, _lens$attachments$map9, _lens$attachments9, _lens$content9, _lens$checkLiveAPI, _lens$attachments$map10, _lens$attachments10, _lens$title5, _lens$endsAt, _lens$content10, _lens$attachments$map11, _lens$attachments11, _lens$content11, _lens$attachments$map12, _lens$attachments12, _lens$links, _lens$attachments$map13, _lens$attachments13, _lens$content12;
  var $schema = _ref.$schema,
    lens = _ref.lens;
  switch ($schema) {
    case metadata.PublicationSchemaId.ARTICLE_LATEST:
      return _objectSpread2({
        ...
        title: (_lens$title = lens.title) !== null && _lens$title !== void 0 ? _lens$title : never(),
        content: lens.content,
        attachments: (_lens$attachments$map = (_lens$attachments = lens.attachments) === null || _lens$attachments === void 0 ? void 0 : _lens$attachments.map(publicationMetadataMedia)) !== null && _lens$attachments$map !== void 0 ? _lens$attachments$map : null
      }, metadataCommon(lens));
    ...
    case metadata.PublicationSchemaId.IMAGE_LATEST:
      return _objectSpread2({
        ...
        content: (_lens$content = lens.content) !== null && _lens$content !== void 0 ? _lens$content : '',
        asset: publicationMetadataMediaImage(lens.image),
        attachments: (_lens$attachments$map2 = (_lens$attachments2 = lens.attachments) === null || _lens$attachments2 === void 0 ? void 0 : _lens$attachments2.map(publicationMetadataMedia)) !== null && _lens$attachments$map2 !== void 0 ? _lens$attachments$map2 : null,
        title: (_lens$title2 = lens.title) !== null && _lens$title2 !== void 0 ? _lens$title2 : ''
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.VIDEO_LATEST:
      return _objectSpread2({
        __typename: 'VideoMetadataV3',
        content: (_lens$content2 = lens.content) !== null && _lens$content2 !== void 0 ? _lens$content2 : '',
        ...
        attachments: (_lens$attachments$map3 = (_lens$attachments3 = lens.attachments) === null || _lens$attachments3 === void 0 ? void 0 : _lens$attachments3.map(publicationMetadataMedia)) !== null && _lens$attachments$map3 !== void 0 ? _lens$attachments$map3 : null,
        title: (_lens$title3 = lens.title) !== null && _lens$title3 !== void 0 ? _lens$title3 : ''
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.AUDIO_LATEST:
      return _objectSpread2({
        __typename: 'AudioMetadataV3',
        content: (_lens$content3 = lens.content) !== null && _lens$content3 !== void 0 ? _lens$content3 : '',
        asset: publicationMetadataMediaAudio(lens.audio),
        title: (_lens$title4 = lens.title) !== null && _lens$title4 !== void 0 ? _lens$title4 : '',
        attachments: (_lens$attachments$map4 = (_lens$attachments4 = lens.attachments) === null || _lens$attachments4 === void 0 ? void 0 : _lens$attachments4.map(publicationMetadataMedia)) !== null && _lens$attachments$map4 !== void 0 ? _lens$attachments$map4 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.TRANSACTION_LATEST:
      return _objectSpread2({
        __typename: 'TransactionMetadataV3',
        content: (_lens$content4 = lens.content) !== null && _lens$content4 !== void 0 ? _lens$content4 : '',
        chainId: lens.chainId,
        txHash: lens.txHash,
        type: publicationMetadataTransactionType(lens.type),
        attachments: (_lens$attachments$map5 = (_lens$attachments5 = lens.attachments) === null || _lens$attachments5 === void 0 ? void 0 : _lens$attachments5.map(publicationMetadataMedia)) !== null && _lens$attachments$map5 !== void 0 ? _lens$attachments$map5 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.EMBED_LATEST:
      return _objectSpread2({
        __typename: 'EmbedMetadataV3',
        content: (_lens$content5 = lens.content) !== null && _lens$content5 !== void 0 ? _lens$content5 : '',
        embed: lens.embed,
        attachments: (_lens$attachments$map6 = (_lens$attachments6 = lens.attachments) === null || _lens$attachments6 === void 0 ? void 0 : _lens$attachments6.map(publicationMetadataMedia)) !== null && _lens$attachments$map6 !== void 0 ? _lens$attachments$map6 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.LINK_LATEST:
      return _objectSpread2({
        __typename: 'LinkMetadataV3',
        content: (_lens$content6 = lens.content) !== null && _lens$content6 !== void 0 ? _lens$content6 : '',
        sharingLink: lens.sharingLink,
        attachments: (_lens$attachments$map7 = (_lens$attachments7 = lens.attachments) === null || _lens$attachments7 === void 0 ? void 0 : _lens$attachments7.map(publicationMetadataMedia)) !== null && _lens$attachments$map7 !== void 0 ? _lens$attachments$map7 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.MINT_LATEST:
      return _objectSpread2({
        __typename: 'MintMetadataV3',
        content: (_lens$content7 = lens.content) !== null && _lens$content7 !== void 0 ? _lens$content7 : '',
        mintLink: lens.mintLink,
        attachments: (_lens$attachments$map8 = (_lens$attachments8 = lens.attachments) === null || _lens$attachments8 === void 0 ? void 0 : _lens$attachments8.map(publicationMetadataMedia)) !== null && _lens$attachments$map8 !== void 0 ? _lens$attachments$map8 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.SPACE_LATEST:
      return _objectSpread2({
        __typename: 'SpaceMetadataV3',
        content: (_lens$content8 = lens.content) !== null && _lens$content8 !== void 0 ? _lens$content8 : '',
        link: lens.link,
        startsAt: lens.startsAt,
        title: lens.title,
        attachments: (_lens$attachments$map9 = (_lens$attachments9 = lens.attachments) === null || _lens$attachments9 === void 0 ? void 0 : _lens$attachments9.map(publicationMetadataMedia)) !== null && _lens$attachments$map9 !== void 0 ? _lens$attachments$map9 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.LIVESTREAM_LATEST:
      return _objectSpread2({
        __typename: 'LiveStreamMetadataV3',
        content: (_lens$content9 = lens.content) !== null && _lens$content9 !== void 0 ? _lens$content9 : '',
        liveURL: lens.liveUrl,
        playbackURL: lens.playbackUrl,
        checkLiveAPI: (_lens$checkLiveAPI = lens.checkLiveAPI) !== null && _lens$checkLiveAPI !== void 0 ? _lens$checkLiveAPI : null,
        startsAt: lens.startsAt,
        attachments: (_lens$attachments$map10 = (_lens$attachments10 = lens.attachments) === null || _lens$attachments10 === void 0 ? void 0 : _lens$attachments10.map(publicationMetadataMedia)) !== null && _lens$attachments$map10 !== void 0 ? _lens$attachments$map10 : null,
        title: (_lens$title5 = lens.title) !== null && _lens$title5 !== void 0 ? _lens$title5 : '',
        endsAt: (_lens$endsAt = lens.endsAt) !== null && _lens$endsAt !== void 0 ? _lens$endsAt : ''
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.THREE_D_LATEST:
      return _objectSpread2({
        __typename: 'ThreeDMetadataV3',
        content: (_lens$content10 = lens.content) !== null && _lens$content10 !== void 0 ? _lens$content10 : '',
        assets: lens.assets.map(function (asset) {
          var _asset$zipPath;
          return {
            __typename: 'ThreeDMetadataV3Asset',
            uri: asset.uri,
            zipPath: (_asset$zipPath = asset.zipPath) !== null && _asset$zipPath !== void 0 ? _asset$zipPath : null,
            playerURL: asset.playerUrl,
            format: asset.format,
            license: asset.license ? publicationMetadataLicenseType(asset.license) : null
          };
        }),
        attachments: (_lens$attachments$map11 = (_lens$attachments11 = lens.attachments) === null || _lens$attachments11 === void 0 ? void 0 : _lens$attachments11.map(publicationMetadataMedia)) !== null && _lens$attachments$map11 !== void 0 ? _lens$attachments$map11 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.CHECKING_IN_LATEST:
      return _objectSpread2({
        __typename: 'CheckingInMetadataV3',
        content: (_lens$content11 = lens.content) !== null && _lens$content11 !== void 0 ? _lens$content11 : '',
        location: lens.location,
        geographic: null,
        attachments: (_lens$attachments$map12 = (_lens$attachments12 = lens.attachments) === null || _lens$attachments12 === void 0 ? void 0 : _lens$attachments12.map(publicationMetadataMedia)) !== null && _lens$attachments$map12 !== void 0 ? _lens$attachments$map12 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.EVENT_LATEST:
      return _objectSpread2({
        __typename: 'EventMetadataV3',
        links: (_lens$links = lens.links) !== null && _lens$links !== void 0 ? _lens$links : null,
        location: lens.location,
        geographic: null,
        startsAt: lens.startsAt,
        endsAt: lens.endsAt,
        attachments: (_lens$attachments$map13 = (_lens$attachments13 = lens.attachments) === null || _lens$attachments13 === void 0 ? void 0 : _lens$attachments13.map(publicationMetadataMedia)) !== null && _lens$attachments$map13 !== void 0 ? _lens$attachments$map13 : null
      }, metadataCommon(lens));
    case metadata.PublicationSchemaId.STORY_LATEST:
      return _objectSpread2({
        __typename: 'StoryMetadataV3',
        asset: publicationMetadataMedia(lens.asset),
        content: (_lens$content12 = lens.content) !== null && _lens$content12 !== void 0 ? _lens$content12 : ''
      }, metadataCommon(lens));
  }
}
function post(_ref2) {
  var by = _ref2.by,
    meta = _ref2["with"];
  var id = publicationId(meta.lens.id);
  return {
    __typename: 'Post',
    id: id,
    by: by,
 ...
 * @group Hooks
 */
function useOptimisticCreatePost(uploader) {
  var metadataUploader = useMemo(function () {
  ...
  var execute = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(args) {
      var mode, upload, request, result;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            invariant((session === null || session === void 0 ? void 0 : session.type) === SessionType.WithProfile, 'You must be authenticated with a Profile to post. Use `useLogin` hook to authenticate.');
          ...
          case 3:
            ...
            // upload the metadata
            _context2.next = 7;
            return metadataUploader.upload(args.metadata);
          case 7:
          ...
          case 11:
            request = createPostRequest(_objectSpread2(_objectSpread2(_objectSpread2({}, args), mode), {}, {
...
var ApproveTransactionGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(ApproveTransactionGateway);
...
var BlockProfilesGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(BlockProfilesGateway);
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", failure(new ClaimHandleError(isClaimReservedHandleRequest(request) ? request.handle : request.localName, data.result.reason)));
            case 6:
              transaction = this.transactionFactory.createNativeTransaction({
                chainType: ChainType.POLYGON,
                id: v4(),
...
var CreateProfileTransactionGateway = /*#__PURE__*/function (_AbstractContractCall) {
  ...
  var _super = _createSuper(CreateProfileTransactionGateway);
...
var FollowProfileGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(FollowProfileGateway);
  ...
  _createClass(FollowProfileGateway, [{
    ...
    key: "resolveFollowLensManagerRequest",
    value: function resolveFollowLensManagerRequest(request) {
      return {
...
var PrematureFollowError = /*#__PURE__*/function (_Error) {
  ...
  var _super = _createSuper(PrematureFollowError);
...
var LinkHandleGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(LinkHandleGateway);
  ...
  _createClass(LinkHandleGateway, [{
    ...
    value: function createLinkCallDetails(result) {
      var contract = lensTokenHandleRegistry(result.typedData.domain.verifyingContract);
...
var OpenActionGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(OpenActionGateway);
...
var ProfileMetadataGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(ProfileMetadataGateway);
...
var UnblockProfilesGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(UnblockProfilesGateway);
...
var UnfollowProfileGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(UnfollowProfileGateway);
...
var UnlinkHandleGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(UnlinkHandleGateway);
...
var UpdateFollowPolicyGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(UpdateFollowPolicyGateway);
...
var UpdateProfileManagersGateway = /*#__PURE__*/function (_ref) {
  ...
  var _super = _createSuper(UpdateProfileManagersGateway);
  ...
  _createClass(UpdateProfileManagersGateway, [{
    ...
    value: function createChangeDelegatedExecutorsConfigCallDetails(data) {
      var contract = lensHub(data.typedData.domain.verifyingContract);
...
function useCanClaimHandle() {
  ...
  return useReadResult(useClaimableProfiles(useLensApolloClient({
    fetchPolicy: 'network-only'
  })));
}
...
function useLastLoggedInProfile(args) {
  var _useReadResult = useReadResult(useLastLoggedInProfile$1(useLensApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
function useLazyProfilesManaged() {
  var _useProfilesManagedLa = useProfilesManagedLazyQuery(useLensApolloClient({
      fetchPolicy: 'no-cache'
    })),
...
function useOwnedHandles(args) {
  return usePaginatedReadResult(useOwnedHandles$1(useLensApolloClient({
    variables: args
  })));
}
...
function useProfilesManaged(args) {
  return usePaginatedReadResult(useProfilesManaged$1(useLensApolloClient({
    variables: useFragmentVariables(args)
  })));
}
 ...
 * @group Hooks
 */
function useRateLimits(args) {
  var _useReadResult = useReadResult(useUserRateLimit(useLensApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
var development = {
  name: 'development',
  backend: 'https://api-v2-amoy.lens.dev',
  chains: _defineProperty(_defineProperty({}, ChainType.ETHEREUM, goerli), ChainType.POLYGON, amoy),
  timings: {
    pollingInterval: 3000,
...
var staging = {
  name: 'staging',
  backend: 'https://api-amoy.lens-v2.crtlkey.com',
  chains: _defineProperty(_defineProperty({}, ChainType.ETHEREUM, goerli), ChainType.POLYGON, amoy),
  timings: {
...
export { BaseProvider, BaseUploader, ConsoleLogger, ConsoleLoggerLevel, HandleNotAvailableError, InvalidHandleError, NotFoundError, OpenActionKind, PrematureFollowError, UploadError, amoy, appId, data, development, goerli, hasReacted, mainnet, mumbai, polygon, production, profileId, publicationId, resolveConfig, staging, uri, url, useAccessToken, useAddProfileInterests, useApolloClient, useApproveModule, useBlockProfiles, useBlockedProfiles, useBookmarkToggle, useBookmarks, useCanClaimHandle, useClaimHandle, useCreateComment, useCreateMirror, useCreatePost, useCreateProfile, useCreateQuote, useCurrencies, useDeferredTask, useDismissRecommendedProfiles, useExploreProfiles, useExplorePublications, useFeed, useFeedHighlights, useFollow, useHideCommentToggle, useHidePublication, useIdentityToken, useInviteWallets, useInvitedProfiles, useLastLoggedInProfile, useLatestPaidActions, useLazyModuleMetadata, useLazyProfile, useLazyProfiles, useLazyProfilesManaged, useLazyPublication, useLazyPublications, useLazyWasWalletInvited, useLinkHandle, useLogin, useLogout, useModuleMetadata, useMutualFollowers, useNotInterestedToggle, useNotifications, useOpenAction, useOptimisticCreatePost, useOwnedHandles, useProfile, useProfileActionHistory, useProfileFollowers, useProfileFollowing, useProfileManagers, useProfiles, useProfilesManaged, usePublication, usePublications, useRateLimits, useReactionToggle, useRecommendProfileToggle, useRecommendedProfiles, useRefreshToken, useRemoveProfileInterests, useReportProfile, useReportPublication, useResolveAddress, useRevenueFromFollow, useRevenueFromPublication, useRevenueFromPublications, useSearchProfiles, useSearchPublications, useSession, useSetProfileMetadata, useSharedDependencies, useSignFrameAction, useStorage, useUnblockProfiles, useUnfollow, useUnlinkHandle, useUpdateFollowPolicy, useUpdateProfileManagers, useUpgradeCredentials, useValidateHandle, useWasWalletInvited, useWhoActedOnPublication, useWhoReactedToPublication };
