 ...
 *
 */
export declare function useUnblockProfiles(): UseDeferredTask<AsyncTransactionResult<void>, BroadcastingError | InsufficientAllowanceError | InsufficientFundsError | InsufficientGasError | PendingSigningRequestError | UserRejectedError | WalletConnectionError, UnblockProfileArgs>;
