...
var CredentialsStorage = /*#__PURE__*/function () {
  function CredentialsStorage(storageProvider, namespace) {
    ...
    var authStorageSchema = new storage.CredentialsStorageSchema("lens.".concat(namespace, ".credentials"));
...
var UriSchema = zod.z.string().min(6).url().transform(function (value) {
  return value;
});
var EvmAddressSchema = zod.z.string().min(42).transform(function (value) {
  return value;
});
var DataSchema = zod.z.string().transform(function (value) {
  return value;
});
...
var FollowRequestSchema = zod.z.union([PaidFollowRequestSchema, FreeFollowRequestSchema]);
...
var FollowPolicyConfigSchema = zod.z.discriminatedUnion('type', [ChargeFollowPolicyConfigSchema, AnyoneFollowPolicyConfigSchema, NoOneFollowPolicyConfigSchema]);
...
var CollectRequestSchema = zod.z.discriminatedUnion('type', [LegacyCollectRequestSchema, SimpleCollectRequestSchema, MultirecipientCollectRequestSchema, UnknownActionRequestSchema]);
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 17:
              ...
              if (!(_context.t0.code === ethers.errors.ACTION_REJECTED)) {
                _context.next = 22;
                break;
              }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 16:
              ...
              if (!(_context2.t0.code === ethers.errors.ACTION_REJECTED)) {
                _context2.next = 21;
                break;
              }
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 17:
              ...
              _context3.next = _context3.t1 === ethers.errors.ACTION_REJECTED ? 23 : _context3.t1 === ethers.errors.INSUFFICIENT_FUNDS ? 24 : 25;
              break;
            case 23:
              return _context3.abrupt("return", sharedKernel.failure(new entities.UserRejectedError(_context3.t0.message)));
            case 24:
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 12:
              ...
              signedVote = new SignedVote(unsignedVote.pollId, _signature3, unsignedVote.typedData, utils.getAddress(this.address));
              return _context4.abrupt("return", sharedKernel.success(signedVote));
            case 17:
              _context4.prev = 17;
              _context4.t0 = _context4["catch"](9);
              assertErrorObjectWithCode(_context4.t0);
              if (!(_context4.t0.code === ethers.errors.ACTION_REJECTED)) {
                _context4.next = 22;
                break;
              }
...
var WalletStorageSchema = zod.z.array(WalletDataSchema);
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", (_this$inMemoryCache$a = this.inMemoryCache[address]) !== null && _this$inMemoryCache$a !== void 0 ? _this$inMemoryCache$a : sharedKernel.never());
            case 2:
              _context.next = 4;
              return this.getAll();
            case 4:
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 26:
              ...
              assertErrorObjectWithCode(_context.t0);
              if (!(_context.t0.code === ethers.errors.UNSUPPORTED_OPERATION)) {
                _context.next = 31;
                break;
              }
...
function createWalletStorage(storageProvider, namespace) {
  var walletStorageDataSchema = new storage.BaseStorageSchema("lens.".concat(namespace, ".wallets"), WalletStorageSchema);
  return storage.Storage.createForSchema(walletStorageDataSchema, storageProvider);
}
...
function createSharedDependencies(config) {
  ...
  var apolloClient = gql.createLensApolloClient({
    queryParams: (_config$params = config.params) !== null && _config$params !== void 0 ? _config$params : gql.defaultQueryParams,
    uri: config.environment.backend,
  ...
  var logout = new authentication.Logout(walletGateway, credentialsGateway, transactionGateway, conversationsGateway, logoutPresenter);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            login = new authentication.Login(walletFactory, walletGateway, credentialsFactory, credentialsGateway, presenter);
            _context.next = 4;
...
function useExploreProfiles() {
  ...
  return usePaginatedReadResult(gql.useExploreProfiles(useLensApolloClient({
    variables: {
      limit: limit,
      where: where,
      orderBy: orderBy
...
function useExplorePublications() {
  ...
  return usePaginatedReadResult(gql.useExplorePublications(useLensApolloClient({
    variables: {
      where: where,
      orderBy: orderBy
    }
...
function useFeed(_ref) {
  ...
  return usePaginatedReadResult(gql.useFeed(useLensApolloClient({
    variables: {
      where: where
    }
  })));
...
function useRecommendedProfiles(args) {
  return usePaginatedReadResult(gql.useProfileRecommendations(useLensApolloClient({
    variables: args
  })));
}
...
function useSearchProfiles(args) {
  return usePaginatedReadResult(gql.useSearchProfiles(useLensApolloClient({
    variables: args
  })));
}
...
function useSearchPublications(args) {
  return usePaginatedReadResult(gql.useSearchPublications(useLensApolloClient({
    variables: args
  })));
}
...
function useProfile(_ref) {
  ...
  var _useReadResult = useReadResult(gql.useProfile(useLensApolloClient({
      variables: {
...
function useProfileFollowers(args) {
  return usePaginatedReadResult(gql.useFollowers(useLensApolloClient({
    variables: args
  })));
}
...
function useProfileFollowing(args) {
  return usePaginatedReadResult(gql.useFollowing(useLensApolloClient({
    variables: args
  })));
}
...
function useProfiles(args) {
  return usePaginatedReadResult(gql.useProfiles(useLensApolloClient({
    variables: args
  })));
}
...
function usePublication(_ref) {
  ...
  var _useReadResult = useReadResult(gql.usePublication(useLensApolloClient({
      variables: {
...
function usePublications(args) {
  return usePaginatedReadResult(gql.usePublications(useLensApolloClient({
    variables: args
  })));
}
...
var mapReportReasonToInput = function mapReportReasonToInput(reason) {
  switch (reason) {
    case entities.ReportReason.VIOLENCE:
      return {
        illegalReason: {
    ...
    case entities.ReportReason.SELF_HARM:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
    ...
    case entities.ReportReason.DIRECT_THREAT:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
    ...
    case entities.ReportReason.HATE_SPEECH:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
    ...
    case entities.ReportReason.ANIMAL_ABUSE:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
    ...
    case entities.ReportReason.SCAM:
    case entities.ReportReason.UNAUTHORIZED_SALE:
      return {
        fraudReason: {
    ...
    case entities.ReportReason.IMPERSONATION:
      return {
        fraudReason: {
          reason: gql.PublicationReportingReason.Fraud,
    ...
    case entities.ReportReason.NUDITY:
      return {
        sensitiveReason: {
    ...
    case entities.ReportReason.OFFENSIVE:
      return {
        sensitiveReason: {
          reason: gql.PublicationReportingReason.Sensitive,
    ...
    case entities.ReportReason.MISLEADING:
      return {
        spamReason: {
    ...
    case entities.ReportReason.MISUSE_HASHTAGS:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
    ...
    case entities.ReportReason.UNRELATED:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
    ...
    case entities.ReportReason.REPETITIVE:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
    ...
    case entities.ReportReason.FAKE_ENGAGEMENT:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
    ...
    case entities.ReportReason.MANIPULATION_ALGO:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
    ...
    case entities.ReportReason.SOMETHING_ELSE:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              gasEstimator = new Eip1559GasPriceEstimator(provider, function (value) {
                return sharedKernel.Amount.matic(value);
              });
              _context.next = 14;
...
var ClaimHandleError = profile.ClaimHandleError;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to create a post. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must have a profile to create a post.');
...
function createFollowRequest(args, session) {
  ...
  switch (followPolicy.type) {
    ...
    case profile.FollowPolicyType.UNKNOWN:
      throw new sharedKernel.InvariantError("The profile is configured with an unknown follow module.");
  }
}
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            request = gql.resolveOpenActionRequestFor(publication, {
              action: args.action,
              signless: session.type === authentication.SessionType.WithProfile ? session.profile.signless : false,
              // cannot use Lens Manager with Public Collect
              "public": session.type === authentication.SessionType.JustWallet,
              sponsored: session.type === authentication.SessionType.WithProfile ? sponsored : false // cannot use gasless with Public Collect
            });
...
Object.defineProperty(exports, 'OpenActionKind', {
  enumerable: true,
  get: function () { return gql.OpenActionKind; }
});
...
Object.defineProperty(exports, 'defaultQueryParams', {
  enumerable: true,
  get: function () { return gql.defaultQueryParams; }
});
...
Object.defineProperty(exports, 'isValidHandle', {
  enumerable: true,
  get: function () { return gql.isValidHandle; }
});
...
Object.defineProperty(exports, 'ReportReason', {
  enumerable: true,
  get: function () { return entities.ReportReason; }
});
...
Object.defineProperty(exports, 'WellKnownSymbols', {
  enumerable: true,
  get: function () { return sharedKernel.WellKnownSymbols; }
});
...
Object.defineProperty(exports, 'usd', {
  enumerable: true,
  get: function () { return sharedKernel.usd; }
});
