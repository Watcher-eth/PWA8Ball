...
var react = require('@lens-protocol/react');
var sharedKernel = require('@lens-protocol/shared-kernel');
var react$1 = require('react');
var createClass = require('../../dist/createClass-3c0c4869.cjs.prod.js');
var reactSdk = require('@xmtp/react-sdk');
var inbox = require('@lens-protocol/domain/use-cases/inbox');
...
function useXmtpClient() {
  ...
  var initializeWithLens = react$1.useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var options,
      existingKeys,
      signer,
      _newClient,
...
exports.useStartLensConversation = useStartLensConversation;
