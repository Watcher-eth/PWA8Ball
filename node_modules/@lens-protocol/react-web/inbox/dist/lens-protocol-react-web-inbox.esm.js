import { profileId, useSession, SessionType, useLazyProfile, useLazyProfiles, useSharedDependencies } from '@lens-protocol/react';
import { invariant, assertError, Deferred } from '@lens-protocol/shared-kernel';
import { useMemo, useEffect, useState, useCallback } from 'react';
import { d as _slicedToArray, e as _arrayLikeToArray, f as _unsupportedIterableToArray, c as _objectSpread2, b as _defineProperty, _ as _createClass, a as _classCallCheck } from '../../dist/createClass-5951666d.esm.js';
...
var CONVERSATION_ID_PREFIX = 'lens.dev/dm';
...
function isLensConversation(activeProfileId, conversationId) {
 ...
 * @experimental
 */
function useStartLensConversation(args) {
  var _useSession = useSession(),
    session = _useSession.data;
  invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
  invariant(session.type === SessionType.WithProfile, 'You must have a profile to use this operation.');
...
function useXmtpClient() {
  ...
  var initializeWithLens = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var options,
      existingKeys,
      signer,
      _newClient,
...
export { useEnhanceConversation, useEnhanceConversations, useStartLensConversation, useXmtpClient };
