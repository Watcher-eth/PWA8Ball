...
var ReportClaim = require('../../dist/ReportClaim-c5e8bb70.cjs.prod.js');
var Transactions = require('../../dist/Transactions-61045839.cjs.prod.js');
var jestWhen = require('jest-when');
var FollowPolicy = require('../../dist/FollowPolicy-12c0d185.cjs.prod.js');
...
function mockProfile() {
  return ReportClaim.Profile.create({
    id: mockProfileId(),
...
function mockIUnsignedVoteFactory(_ref) {
  var request = _ref.request,
    vote = _ref.vote;
  var factory = jestMockExtended.mock();
  jestWhen.when(factory.createUnsignedVote).calledWith(request).mockResolvedValue(vote);
  return factory;
}
...
function mockIProfileTransactionGateway(_ref) {
  var request = _ref.request,
    result = _ref.result;
  var profileTransactionGateway = jestMockExtended.mock();
  jestWhen.when(profileTransactionGateway.createProfileTransaction).calledWith(request).mockResolvedValue(result);
...
function mockNoFeeFollowConfig(overrides) {
  return _objectSpread2({
    type: FollowPolicy.FollowPolicyType.ANYONE
  }, overrides);
}
...
function mockProveNftOwnershipRequest() {
  return {
    contractAddress: mocks.mockEvmAddress(),
    chainId: faker.faker.datatype.number(),
    ownerAddress: mocks.mockEvmAddress(),
    tokenId: faker.faker.datatype.uuid()
  };
}
...
function mockINftOwnershipChallengeGateway(_ref2) {
  ...
  jestWhen.when(gateway.createOwnershipChallenge).calledWith(request).mockResolvedValue(result);
  return gateway;
}
...
function mockReportPublicationRequest(overrides) {
  return _objectSpread2({
    publicationId: mockPublicationId(),
    reason: ReportClaim.ReportReason.FAKE_ENGAGEMENT,
...
exports.mockCreateUnsignedVoteRequest = mockCreateUnsignedVoteRequest;
...
exports.mockICredentials = mockICredentials;
...
exports.mockINftOwnershipChallengeGateway = mockINftOwnershipChallengeGateway;
exports.mockIOnChainRelayer = mockIOnChainRelayer;
exports.mockIPayTransactionGateway = mockIPayTransactionGateway;
exports.mockIProfileTransactionGateway = mockIProfileTransactionGateway;
...
exports.mockISignedVote = mockISignedVote;
...
exports.mockIUnsignedVote = mockIUnsignedVote;
exports.mockIUnsignedVoteFactory = mockIUnsignedVoteFactory;
...
exports.mockNftOwnershipChallenge = mockNftOwnershipChallenge;
exports.mockNftOwnershipSignature = mockNftOwnershipSignature;
exports.mockNoFeeFollowConfig = mockNoFeeFollowConfig;
exports.mockNonce = mockNonce;
exports.mockPaidFollowRequest = mockPaidFollowRequest;
exports.mockPollId = mockPollId;
...
exports.mockProveNftOwnershipRequest = mockProveNftOwnershipRequest;
...
exports.mockVotePollRequest = mockVotePollRequest;
