...
import { ISignedProtocolCall, AnyTransactionRequestModel, IUnsignedProtocolCall, UnsignedTransaction, NativeTransaction, ProtocolTransactionRequestModel } from "./Transactions.js";
import { ISignedVote, IUnsignedVote } from "./polls.js";
...
export declare abstract class Wallet {
    ...
    abstract signVote(unsignedVote: IUnsignedVote): PromiseResult<ISignedVote, PendingSigningRequestError | UserRejectedError | WalletConnectionError>;
}
