...
var DuplicatedHandleError = /*#__PURE__*/function (_Error) {
  createSuper._inherits(DuplicatedHandleError, _Error);
  var _super = createSuper._createSuper(DuplicatedHandleError);
  function DuplicatedHandleError(handle) {
    var _this;
    createClass._classCallCheck(this, DuplicatedHandleError);
    _this = _super.call(this, "Handle \"".concat(handle, "\" is already taken"));
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this), "name", 'DuplicatedHandleError');
    return _this;
  }
  return createClass._createClass(DuplicatedHandleError);
}( /*#__PURE__*/wrapNativeSuper._wrapNativeSuper(Error));
...
var ProveNftOwnership = /*#__PURE__*/function () {
  function ProveNftOwnership(activeWallet, gateway, presenter) {
    createClass._classCallCheck(this, ProveNftOwnership);
    this.activeWallet = activeWallet;
    this.gateway = gateway;
    this.presenter = presenter;
  }
  createClass._createClass(ProveNftOwnership, [{
    key: "proveOwnership",
    value: function () {
      var _proveOwnership = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(request) {
...
exports.DuplicatedHandleError = DuplicatedHandleError;
exports.FollowProfile = FollowProfile;
exports.LinkHandle = LinkHandle;
exports.ProveNftOwnership = ProveNftOwnership;
