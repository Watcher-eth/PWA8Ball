...
import { S as SponsorshipReady } from '../../../dist/SponsorshipReady-1877743d.esm.js';
import { _ as _defineProperty, a as _wrapNativeSuper } from '../../../dist/wrapNativeSuper-47ca280c.esm.js';
export { F as FollowPolicyType } from '../../../dist/FollowPolicy-1ce77379.esm.js';
...
var DuplicatedHandleError = /*#__PURE__*/function (_Error) {
  _inherits(DuplicatedHandleError, _Error);
  var _super = _createSuper(DuplicatedHandleError);
  function DuplicatedHandleError(handle) {
    var _this;
    _classCallCheck(this, DuplicatedHandleError);
    _this = _super.call(this, "Handle \"".concat(handle, "\" is already taken"));
    _defineProperty(_assertThisInitialized(_this), "name", 'DuplicatedHandleError');
    return _this;
  }
  return _createClass(DuplicatedHandleError);
}( /*#__PURE__*/_wrapNativeSuper(Error));
var CreateProfile = /*#__PURE__*/function () {
  function CreateProfile(transactionFactory, transactionQueue, presenter) {
      ...
      var _execute = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.transactionFactory.createProfileTransaction(request);
            case 2:
              result = _context.sent;
              if (!result.isFailure()) {
                _context.next = 6;
...
var ProveNftOwnership = /*#__PURE__*/function () {
  function ProveNftOwnership(activeWallet, gateway, presenter) {
    _classCallCheck(this, ProveNftOwnership);
    this.activeWallet = activeWallet;
    this.gateway = gateway;
    this.presenter = presenter;
  }
  _createClass(ProveNftOwnership, [{
    key: "proveOwnership",
    value: function () {
      var _proveOwnership = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        var challenge, wallet, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.gateway.createOwnershipChallenge(request);
            case 2:
      ...
      function proveOwnership(_x) {
        return _proveOwnership.apply(this, arguments);
      }
      return proveOwnership;
    }()
  }]);
  return ProveNftOwnership;
}();
...
export { BlockProfiles, ClaimHandle, ClaimHandleError, CreateProfile, DismissRecommendedProfiles, DuplicatedHandleError, FollowProfile, LinkHandle, ProveNftOwnership, SetProfileMetadata, UnblockProfiles, UnfollowProfile, UnlinkHandle, UpdateFollowPolicy, UpdateProfileManagers, isClaimReservedHandleRequest, isPaidFollowRequest };
