        ...
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              sharedKernel.invariant(wallet, 'Active wallet should exist when credentials are present');
...
var Logout = /*#__PURE__*/function () {
  function Logout(walletGateway, credentialsGateway, transactionGateway, conversationsGateway, presenter) {
      ...
      var _execute = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(reason) {
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.walletGateway.reset();
            case 2:
              _context.next = 4;
              return this.conversationsGateway.reset();
            case 4:
              _context.next = 6;
              return this.transactionGateway.reset();
            case 6:
              _context.next = 8;
              return this.credentialsGateway.invalidate(reason);
            case 8:
...
var Login = /*#__PURE__*/function () {
  function Login(walletFactory, walletGateway, credentialsIssuer, credentialsWriter, presenter) {
      ...
      var _execute = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(request) {
        ...
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.walletFactory.create(request.address);
            case 2:
              wallet = _context.sent;
              _context.next = 5;
