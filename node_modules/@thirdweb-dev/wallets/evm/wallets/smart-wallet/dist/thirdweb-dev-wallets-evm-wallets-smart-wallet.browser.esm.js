...
import { a as AbstractClientWallet } from '../../../../dist/base-50292e8c.browser.esm.js';
import { w as walletIds } from '../../../../dist/walletIds-dff6dced.browser.esm.js';
import { getValidChainRPCs } from '@thirdweb-dev/chains';
import { utils } from 'ethers';
import { e as isZkSyncChain, c as checkContractWalletSignature } from '../../../../dist/utils-5fdc349b.browser.esm.js';
export { D as DEFAULT_FACTORY_ADDRESS, g as getAllSigners, a as getAllSmartWallets, b as getSmartWalletAddress, d as getUserOpReceipt, i as isSmartWalletDeployed, e as isZkSyncChain } from '../../../../dist/utils-5fdc349b.browser.esm.js';
  ...
  async getConnector() {
    if (!this.connector) {
      if (this.options && (await isZkSyncChain(this.options.chain, this.options.clientId, this.options.secretKey))) {
        const {
          ZkSyncConnector
        } = await import('../../../../dist/zk-connector-9df28418.browser.esm.js');
