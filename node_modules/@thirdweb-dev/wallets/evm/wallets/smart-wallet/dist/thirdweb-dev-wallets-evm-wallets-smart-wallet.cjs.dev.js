...
var evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase = require('../../../../dist/base-e11a2e19.cjs.dev.js');
var walletIds = require('../../../../dist/walletIds-a0be5020.cjs.dev.js');
var chains = require('@thirdweb-dev/chains');
var ethers = require('ethers');
var utils = require('../../../../dist/utils-46dfa3a2.cjs.dev.js');
require('../../abstract/dist/thirdweb-dev-wallets-evm-wallets-abstract.cjs.dev.js');
require('eventemitter3');
require('@thirdweb-dev/sdk');
require('../../../../dist/headers-0c03c5a9.cjs.dev.js');
  ...
  async getConnector() {
    if (!this.connector) {
      if (this.options && (await utils.isZkSyncChain(this.options.chain, this.options.clientId, this.options.secretKey))) {
        const {
          ZkSyncConnector
        } = await Promise.resolve().then(function () { return require('../../../../dist/zk-connector-362d81cd.cjs.dev.js'); });
