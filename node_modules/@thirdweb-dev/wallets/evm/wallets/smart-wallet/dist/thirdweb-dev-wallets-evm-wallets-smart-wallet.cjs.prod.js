...
var evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase = require('../../../../dist/base-4c41e1c9.cjs.prod.js');
var walletIds = require('../../../../dist/walletIds-6ed32bf4.cjs.prod.js');
var chains = require('@thirdweb-dev/chains');
var ethers = require('ethers');
var utils = require('../../../../dist/utils-1907581a.cjs.prod.js');
require('../../abstract/dist/thirdweb-dev-wallets-evm-wallets-abstract.cjs.prod.js');
require('eventemitter3');
require('@thirdweb-dev/sdk');
require('../../../../dist/headers-aef9bde6.cjs.prod.js');
  ...
  async getConnector() {
    if (!this.connector) {
      if (this.options && (await utils.isZkSyncChain(this.options.chain, this.options.clientId, this.options.secretKey))) {
        const {
          ZkSyncConnector
        } = await Promise.resolve().then(function () { return require('../../../../dist/zk-connector-b9d924a6.cjs.prod.js'); });
