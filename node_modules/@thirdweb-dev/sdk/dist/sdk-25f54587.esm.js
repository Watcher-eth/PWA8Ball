...
import { b as buildTransactionFunction, T as Transaction, a as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-5391a540.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-93eac1c5.esm.js';
...
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployContractDeterministic-def96f62.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-8588c04a.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
