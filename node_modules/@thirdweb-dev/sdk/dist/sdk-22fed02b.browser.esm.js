...
import { g as getDefaultGasOverrides, f as buildTransactionFunction, T as Transaction, h as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-403814af.browser.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-36d56838.browser.esm.js';
...
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployContractDeterministic-fae429e5.browser.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-2711c0a1.browser.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
