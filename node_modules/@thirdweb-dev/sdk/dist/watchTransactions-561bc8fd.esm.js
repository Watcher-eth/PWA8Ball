import { d8 as createLruCache, b8 as getSignerAndProvider, aQ as resolveAddress, ap as getCompositeABI, bo as AbiSchema, j as getContractTypeForRemoteName, h as PREBUILT_CONTRACTS_MAP } from './index-8a8ce563.esm.js';
...
async function getContractFromAbi(params) {
  ...
  const [resolvedAddress, {
    ...
    SmartContract
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./smart-contract-8588c04a.esm.js')]);
...
async function getContract(params) {
  ...
  const [resolvedAddress, {
    ...
    ContractPublisher
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./contract-publisher-91525abb.esm.js').then(function (n) { return n.c; })]);
  if (inContractCache(resolvedAddress, chainId)) {
    return getCachedContract(resolvedAddress, chainId);
  }
