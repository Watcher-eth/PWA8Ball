...
var formElements = require('./formElements-c9feec2d.cjs.prod.js');
var Tooltip = require('./Tooltip-9d43759f.cjs.prod.js');
...
var coinbaseWallet = require('./safeChainSlug-59319398.cjs.prod.js');
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Tooltip.ScreenContext.Provider, {
    ...
    children: isWideModal ? /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(LeftContainer, {
        ...
        scrollY: true,
        relative: true,
        children: [screen === Tooltip.reservedScreens.signIn && signatureScreen, screen === Tooltip.reservedScreens.main && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
          children: getStarted
      ...
      children: [screen === Tooltip.reservedScreens.signIn && signatureScreen, screen === Tooltip.reservedScreens.main && walletList, screen === Tooltip.reservedScreens.getStarted && getStarted, typeof screen !== "string" && getWalletUI(screen)]
    })
  });
};
const ConnectModal = () => {
...
function ConnectEmbed(props) {
  ...
  React.useEffect(() => {
    if (requiresSignIn && screen === Tooltip.reservedScreens.main) {
      setScreen(Tooltip.reservedScreens.signIn);
    }
  }, [requiresSignIn, screen, setScreen]);
  if (show) {
    return /*#__PURE__*/jsxRuntime.jsx(ConnectEmbedContent, {
      ...props,
      onClose: () => {
        setScreen(initialScreen);
      },
...
const ConnectEmbedContent = props => {
  ...
  const walletUIStatesProps = {
    theme: props.theme || contextTheme || Tooltip.defaultTheme,
    modalSize: modalSize,
    title: undefined,
    termsOfServiceUrl: props.termsOfServiceUrl,
    privacyPolicyUrl: props.privacyPolicyUrl,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(formElements.WalletUIStatesProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(formElements.CustomThemeProvider, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(EmbedContainer, {
        className: props.className,
        style: {
          height: "auto",
          maxWidth: Tooltip.modalMaxWidthCompact,
          ...props.style
        },
  ...
  return /*#__PURE__*/jsxRuntime.jsx(formElements.WalletUIStatesProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(formElements.CustomThemeProvider, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(ConnectModalInlineContainer, {
        ...
        children: [modalSize === "compact" ? /*#__PURE__*/jsxRuntime.jsxs(DynamicHeight, {
          children: [" ", content, " "]
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-59319398.cjs.prod.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-59319398.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async options => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-59319398.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-59319398.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-bd873872.cjs.prod.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-060e5fea.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-39190409.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-59319398.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
