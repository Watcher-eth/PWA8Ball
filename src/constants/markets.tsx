export const HARD_MARKETS = [
    ...
    options: [
      {
        ...
        image:
          "https://static.wixstatic.com/media/be9a23_023cf2f136b94c4b924aafc1f47b2f39~mv2.png/v1/fill/w_318,h_310,al_c,lg_1,q_85,enc_auto/be9a23_023cf2f136b94c4b924aafc1f47b2f39~mv2.png",
      },
      {
        name: "Republicans",
        address: "0x0000000000000000000000000000000000000000",
    ...
    options: [
      {
        ...
        address: "0x0000000000000000000000000000000000000000",
        image:
          "https://media.newyorker.com/photos/669fcdc75b14c0c338d75478/master/w_2560%2Cc_limit/StFelix-Kamala-Reuters.jpg",
      },
      {
        name: "Trump",
        address: "0x0000000000000000000000000000000000000000",
        image:
          "https://media-cldnry.s-nbcnews.com/image/upload/rockcms/2024-02/240215-donald-trump-ew-412p-fa4e4c.jpg",
      },
    ],
    PolyId:
  ...
  {
    id: 3, // P Diddy sentences
    title: "P. Diddy Sentences",
    image:
      "https://img.thedailybeast.com/image/upload/c_crop,d_placeholder_euli9k,h_1688,w_3000,x_0,y_0/dpr_1.5/c_limit,w_1044/fl_lossy,q_auto/v1726619728/240917-puff-daddy-prison-tease_ogw9xo",
    options: [
      {
        name: "Yes",
        address: "0x4a59d33Fa7675E5036Da4cD0db0930c59AC2a570",
      },
      {
        name: "No",
        address: "0x2Fbc9fC98BF6BA6155A6820cd67Ff0E3f50D7bCD",
      },
    ],
    PolyId: "",
  },
  {
    ...
    image:
      "https://images.mirror-media.xyz/publication-images/yyhMh-YKnMgC0jETSQqvv.png?height=1200&width=2400",
    options: [
      {
        name: "Yes",
        address: "0x4a59d33Fa7675E5036Da4cD0db0930c59AC2a570",
  ...
  },
  {
    ...
    options: [
      {
        name: "Yes",
        address: "0x34f89346Ec3D0DEb92D0Bb3754F73a93aBd52bAE",
      },
      {
        name: "No",
        address: "0xB41D6d26Ce49F8B6B66cb5eE04E6dd53Eaa97F0d",
      },
    ],
    PolyId: "",
  },
  {
    ...
    options: [
      {
        name: "Yes",
        address: "0x5345b0DAD86C3b2215feB0C67883b7d56201862b",
      },
      {
        name: "No",
        address: "0xFe76ad827492D900238856344ddc5Fb20B8CA314",
      },
    ],
    PolyId:
  ...
  },
  {
    ...
    title: "RFK state win",
    image:
      "https://media.vanityfair.com/photos/651ebfd51645585645037a4a/master/pass/RFK-Jr-Media.jpg",
    options: [
      {
        name: "Yes",
        address: "0x0000000000000000000000000000000000000000",
    ...
    PolyId:
      "23847111903927180455839741444303778460642896045442356128833806329900513755066",
  },
  {
    id: 9, // Hezbollah invade Israel
    ...
    options: [
      {
        name: "Yes",
        address: "0x115cE71B3E20aF373eE85Bd31B42a16f07DCf54f",
      },
      {
        name: "No",
        address: "0x8486C96b72087620ADfB3D22D6a352a46EF4ECD4",
      },
    ],
    PolyId:
      "67422930937730355379673770686207084338878286706500449221985014557562170327753",
  },
  {
    id: 10, // GTA 6 Price
    title: "GTA 6 Price",
    image:
      "https://rockstarintel.com/wp-content/uploads/2024/03/GTA-VI-article-image-illustration-2.webp",
    options: [
      {
        name: "Yes",
        address: "0xab55848b577503663eD9b25428601B3027Ed0E05",
      },
      {
        name: "No",
        address: "0x41bF221a634A539dA96Ce6b6729Dc5423E2400d9",
      },
    ],
    PolyId: "",
  },
  {
    ...
    PolyId:
      "6181401096199368004324244642874162057010167408218412244771664244595886623212",
  },
  {
    id: 12, // Arizona
    title: "Arizona",
  ...
  {
    id: 17, // Hezbollah invade Israel attack Lebanon
    title: "Hezbollah invade Israel",
    image:
      "https://dialogo-americas.com/wp-content/uploads/2024/03/LAT-Embeded-Hezbola-COLLAGE.jpg",
  ...
  },
  {
    ...
    title: "Nevada",
    image:
      "https://media.npr.org/assets/img/2022/06/08/nevada_wide-0968e892c8f58bfe722844316eebda5c46ee9756.png",
    options: [
      {
        name: "Kamala",
        address: "0x0000000000000000000000000000000000000000",
