...
export const RouterV1ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "fsig", type: "bytes4", indexed: false, internalType: "bytes4" },
      {
        name: "keysHash",
        type: "bytes32",
        indexed: false,
