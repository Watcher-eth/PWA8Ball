      ...
      >
        <div className="flex w-full pt-3 space-x-3">
          <motion.button
            onClick={() => setStep(0)}
            className={`
         py-2 px-6  h-12 w-1/2 rounded-full bg-[#131313] text-lg text-[#D9D9D9] font-bold
          flex-1
        `}
          >
            Back
          ...
          {loading || success || error ? (
            ...
            >
              <TxStatusButton
                minWidth={"min-w-[12rem] xl:min-w-[15vw] w-full"}
                height="h-12"
                isPending={loading}
                isSuccess={success}
                isError={error}
          ...
          font-bold flex items-center justify-center gap-1 w-full self-center
