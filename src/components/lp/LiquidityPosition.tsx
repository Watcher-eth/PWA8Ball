...
export function DesktopLiquidityPosition({
  ...
  return (
    <DesktopLpModal
      ...
      amountLp={amountLp}
    >
      <motion.div className="flex min-h-[20vh] border-2 border-[#252525] justify-between hover:scale-101 active:scale-97 flex-col p-3.5 pt-3 pb-3 rounded-[15px] bg-[rgba(49,49,49,0.78)] mb-[15px] relative cursor-pointer overflow-hidden">
        <img
        ...
        <div className="flex flex-row justify-between items-center relative z-2">
          ...
          <motion.button
            onClick={() => {}}
            className="py-[5.5px] px-[10px] rounded-[17px] backdrop-blur-lg border-[0.1rem] border-[#9a9a9a] overflow-hidden bg-[rgba(20,20,20,0.2)] cursor-pointer"
          >
            <span className="text-[14px] text-white font-['Aeonik-Bold'] font-normal">
              Withdraw Boost
            </span>
