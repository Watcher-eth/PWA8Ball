      ...
      <div className="flex items-center mt-2 w-full  m-4 mx-6  mx-2">
        ...
        >
          <Button
            ...
            className="active:bg-gray-300 hover:bg-gray-300 bg-gray-200 text-[1.15rem] font-bold h-[2.8rem] rounded-full "
          >
            Back
          </Button>
        </motion.div>
        ...
        <motion.div
          ...
          className="w-1/2"
        >
          <Button className="active:bg-black hover:bg-black bg-black text-[1.15rem] text-white font-bold  h-[2.8rem] rounded-full ">
            Continue
          </Button>
        </motion.div>
      </div>
...
function BuyWithFiat(props: { setStep: (step: number) => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="h-[0.05rem] w-full my-6 bg-[#909090] mx-6 mb-4 rounded-full" />
      ...
      <div className="text-[lightgray]  flex w-full justify-between  text-base/[1rem]  items-center px-1 text-[1rem] mb-8  font-bold mx-6">
        <div>Reccomended Minimum</div> <div className="text-[#909090]">15$</div>
      </div>
      <Button
        className="active:bg-[#0000FF] flex items-center hover:bg-[#0000FF] bg-[#909090] text-[1.15rem] mx-6 font-bold h-[2.8rem]  text-white rounded-md my-3 w-full"
      ...
      <Button
        className="active:bg-[#181818] mb-5 flex items-center hover:bg-[#181818] bg-[#212121] text-[1.15rem] mx-6 font-bold text-white h-[2.9rem] rounded-md mt-2 w-full"
        onClick="window.open('https://buy-sandbox.moonpay.com/?apiKey=pk_test_123', '_blank')"
      >
      ...
      <div className="flex items-center mt-2 w-full m-4 mx-6 justify-between mx-2">
        ...
        <motion.div
          ...
          className="w-1/2"
        >
          <Button className="active:bg-gray-200 hover:bg-gray-200 bg-gray-200 text-[1.15rem] text-gray-700 border-2 border-stone-300 border-dashed font-bold  h-[2.8rem] rounded-full ">
            Continue
          </Button>
        </motion.div>
      </div>
