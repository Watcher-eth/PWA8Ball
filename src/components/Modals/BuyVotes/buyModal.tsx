  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col ">
        {" "}
        <div className="text-gray-400 flex items-center space-x-[0.3rem]  text-[1rem] font-bold  mx-[1.65rem]">
          Your Address
        </div>
        <div className="text-gray-900 flex items-center space-x-[0.35rem]  text-[1.25rem] font-bold  mx-[1.65rem]">
          <div>{shortenAddress(address, false)} </div>
          <motion.div
      ...
      <div className="flex mt-2 w-[91vw] items-center justify-between">
        <div className="text-gray-400 text-[1rem] m-[-0.2rem] font-bold mx-[1.65rem]">
          Network
        </div>
        <div className="text-gray-900 flex items-center space-x-[0.3rem]  text-[1.15rem] font-bold  mx-[1.65rem]">
          <Avatar className="h-[1.3rem] w-[1.3rem] mt-[0.1rem]  ">
            <AvatarImage src="https://imgs.search.brave.com/vpKdSh0_Edtglo6tYBmE3eUfb0tu375fPVPUoV6S40c/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9zZWVr/bG9nby5jb20vaW1h/Z2VzL1AvcG9seWdv/bi1tYXRpYy1sb2dv/LTg2RjRENkQ3NzMt/c2Vla2xvZ28uY29t/LnBuZw" />
          </Avatar>
          <div>Polygon </div>
        </div>
      </div>
