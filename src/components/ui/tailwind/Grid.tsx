import type { StyleLookUpInterface } from "@/components/ui/tailwind/types"
...
/**
 * Grid component for creating responsive grid layouts using Tailwind CSS classes.
 *
 * @component
 * @example
 * // Basic usage
 ...
 *
 * @example
 * // Advanced usage with different gaps for different screen sizes
 * <Grid
 ...
 * @param {Object} [props.cols] - The number of columns for different screen sizes.
 * @param {number} [props.cols.xs] - Number of columns for extra small screens.
 * @param {number} [props.cols.sm] - Number of columns for small screens.
 * @param {number} [props.cols.md] - Number of columns for medium screens.
 * @param {number} [props.cols.lg] - Number of columns for large screens.
 * @param {number} [props.cols.xl] - Number of columns for extra large screens.
 * @param {number|Object} [props.gap] - The gap between grid items. Can be a number or an object for responsive gaps.
 * @param {string} [props.gapX] - The horizontal gap between grid items.
 * @param {string} [props.gapY] - The vertical gap between grid items.
 * @param {string} [props.className] - Additional CSS classes to apply to the grid.
...
export function Grid({
  ...
  if (gap) {
    if (Number.isInteger(gap)) {
      ...
      for (const [screenSize, gapSize] of Object.entries(gap)) {
        novelClassName += SIZE_GAP_LOOKUP[screenSize][gapSize as number]
      }
    }
  }
